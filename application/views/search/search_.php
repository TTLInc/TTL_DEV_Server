...
<?php //$this->layout->appendFile('javascript',"js/mapv3.js");?>
<?php 
...
//$this->layout->appendFile('javascript',"http://maps.googleapis.com/maps/api/js?key=AIzaSyCSFpeVsw_KWwduTJUXinAG09guE5_lOOU&sensor=false");
...
.sendMessageView{
	...
	z-index: 1028; left:inherit !important;
}
.btn_blue_bg{
...
document.getElementById("imghid").style.visibility = 'visible';
    ...
    <div class="search_mid">
		<div class="search_lf">
			...
			<?php } ?>
				...
				<dl>
					...
					<span class="icon_none"><?php echo $OpenSlot;?></span>
					</dt>
					<dd>
						<span class="nobg check">
							...
							<label for="anytutor" class="radio-btn"><span class="searchat"><?php echo $lanytutor;?></span></label>
						</span>
						<!--
					...
					<dd>
						...
						<span class="nobg check">
							...
							<label for="datetime" class="radio-btn"><span class="searchdt"><?php echo $ldatetimelocal; ?></span></label>
						</span>
						<?php 
							if(@$sessionSearchData["datetimeSelected"] == 'true'){
					...
					<dd>
						<span class="nobg check">
							...
							<label for="readytotalknow" class="radio-btn"><span class="searchrt"><?php echo $lreadytotalk; ?></span></label>
						</span> 
					</dd>
				</dl>
				...
				<dl>
					...
					<dd>
						<!--<input name="keywords" id="keywords" type="text" class="raduisSelect" style="width:170px; height:21px;"  value="<?php if(@$sessionSearchData["keywordSelected"]){echo $sessionSearchData["keywordSelected"];}else{echo $exp;}; ?>" onblur="if(this.value == '') this.value = '<?php echo $exp;?>'" onfocus="if(this.value == '<?php echo $exp; ?>') this.value = ''">-->
						<input name="keywords" id="keywords" type="text" class="raduisSelect" style="width:170px; height:21px;" value="<?php @$sessionSearchData["keywordSelected"] ?>" placeholder="<?php echo $exp;?>">
					</dd>
				</dl>
				
				
				<dl>
					<dt><span class="c133e5f icon_8"><?php echo $SchoolNm;?></span></dt>
					<dd>
        ...
        <div class="src-hd" style="margin-bottom:30px;">
			...
			<div style="clear:both;" class="rem_clear"></div>
			...
			<!--R&D@Nov-29-2013 : Set Static Map-->
                ...
                <span style="float:right;color:white;font-size:16px;" class="icon-map serch-pop"><?php echo $vmap; ?><img id="imghid" src="<?php echo site_url('images/map.png')?>" onclick="div_show();"/> <span class="classic"><?php echo $viewmap;?></span></span>
			...
			<div class="search_rt_mid martop">
				<div class="search_rt_mid_t">
					<div style=" float: left; width: 245px;">
						<span class="search_rt_mid_t_lf lh30"><?php echo $lshowing;?> <font class="number nowShow">1-20</font> <?php echo $loutof; ?> <font class="number count">20</font> <?php echo $lresults;?></span><span id="keydisplayd" style="line-height: 30px;margin-left: 5px;"></span>
					</div>
					<div class="search_rt_mid_t_rt flt-rgt">
						<div class="v_ajax_page"></div>
					</div>
					<select class="raduisSelect w78 search_rt_mid_t_rt mr30 sortKeys flt-rgt">
...
<dd>
	<div class="dd_top">
		...
		<span class="mytool gold" title="<?php echo $lgold; ?>">	{($T.roleId == 3) ? '<img title="<?php echo $lgold; ?>"  src="<?php echo base_url('images/gold.png')?>">' : ''}</span>
            ...
            <div class="stars"><a onclick="getfeedback({$T.uid});"><span class="current_rating" style="width:{$T.avgRate*30}px" ></span><span class="one-star" ></span><span class="two-stars"></span><span class="three-stars" ></span><span class="four-stars" ></span><span class="five-stars" ></span></a></div>
             <?php
		   if($this->session->userdata('roleId') == 0 OR $this->session->userdata('roleId') == 1 ){
		   ?>
 {($T.chkfreesession == "Yes") ? "<div class='sr-div-show'><span class='free-sesn-srch serch-pop'><a><?php echo $free_session; ?></a> 
...
<?php endif; ?>
 ...
 <div id="dialog1" title="" style="display:None;">
			...
			<div class="ratelist">
				...
				<input type="radio" name="amex"  value="1" checked>  <?php echo  $CUrriculams;?>     - <?php echo $StructureLearning ;?> <span id="Curr"> </span><?php echo $CreditsTut;?><br>
				<div style="display:none" id="dispCurr">
				<input  id="conversationcheck" value="0" type="radio" name="amex">  <?php echo  $ConvesationS;?> <?php echo $InformalSpeaking ;?><span id="Conv" id="conversationprise"  > </span><?php  echo $CreditsTut;?><br><br>
 				</div>
 				<p class="clearer"></p>
			</div>
			<p><input type="button" value="<?php echo $Oks;?>" onclick="closeFunc();"  id="rateButtonStu" class="blu-btn"/>
            	...
            	<div class="step-div-bg">
                	...
                	<div class="pop-pagin">
                    	<ul>
                            ...
                            <li><span><a href="<?php echo base_url('user/profile/uid/405?step=3');?>">3</a></span></li>
            		...
            		<a href="<?php echo base_url('user/profile/uid/405?step=2');?>"><?php //echo $secondStep;?>Next</a>
                </div>
            </div>

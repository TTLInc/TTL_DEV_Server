            ...
            <div id="student_prof_Wp">
            	<div class="mod">
                    ...
                    <div class="content tle" style="padding-top:0px;">
						<h2>
							<?php echo $lcurrentbalance;?>: (<?php if($profile['money'] < 0){ echo "0.00";}else{ echo $profile['money'] = $profile['purchased_credits'] + $profile['earned_credits'] + $profile['coupon_credits']; }?> <?php //echo $credittext; ?>)<span style="font-size:18px;margin-left:304px;"><?php echo $oneusd; ?></span>

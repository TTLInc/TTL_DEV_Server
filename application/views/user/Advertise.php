...
$all	= $arrVal[$multi_lang];

$arrVal 	= $this->lookup_model->getValue('915', $multi_lang);
$languages	= $arrVal[$multi_lang];
            ...
            <div id="student_prof_Wp">
                ...
                <div class="mod">
					<div class="content tle"><h2><?php echo $advertise;?></h2> <div style="float: right; margin-top: -40px;">
					 <span style="font-size:12px; margin-right:10px;"><?php echo $languages; ?></span> <select name="lang" id="position" onchange="getall(this.value);">
	<option value=""><?php echo $all;?></option>
	<option value="1">English</option>
	<option value="3">简体中文</option>
	<option value="6">简体中文</option>
	<option value="4">日本の</option>
	<option value="2">한국의</option>
...
$.ajax({
				 ...
				 //$("#dynamic").append('<p class="by-btn"><a  style="cursor:pointer;" id="" onclick="test();">Download</a></p>');
					...
					$("#dynamic").append('<ul style="width:25%;max-height:205px;display:inline;clear:none;margin-bottom:20px;"><li style="border:0px;"><p class="credit"><input type="checkbox" name="ids[]" value="'+uid+'">&nbsp;&nbsp;<a href="#"><span class="tut-img"><img src='+url+img+' width=auto height=100px" ><h4>'+name+'</h4></span></a></p></li></ul>');

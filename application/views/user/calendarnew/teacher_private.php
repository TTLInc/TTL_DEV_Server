        	...
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp" class="cld-txt">
										...
										<div class="header_pic">
											...
											<?php 
												...
												else
												{
													...
													?>
													<img src="<?php echo $class['pic']?Base_url('/uploads/images/thumb/'.$tutorDetails['pic']):Base_url('images/header.jpg');?>" width="78" height="80" />
													<?php
												}?>
					...
					<?php if($uri ==''){?>
					  <div class="mod">
		            <div class="hd">
					 <?php if($classes==array()){?><hr style="color:#D7BC4D !important;border-top: 2.5px solid #D7BC4D;" /><?PHP }?><span style="margin-left:200px;font-size:14px;font-weight: bold;" class="cclicktimeslot"> <?php echo $ClickToslot;?></span>
					</div></div>

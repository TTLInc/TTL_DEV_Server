...
<dl style="clear:both;" class="clearfix" id="tutRateF">
			...
			<dd><input type="text" class="raduisSelect" placeholder="<?php echo $pay_email;?>" id="payment_account" value="<?php echo @$profile['payment_account'];?>" onblur="return chkpayemail();" /><span>&nbsp;*
	...
	<dl style="clear:both;">
			...
			<dd ><input type="text" class="raduisSelect" placeholder="<?php echo $lFIRST_NAME. "/". $lLAST_NAME;?>" id="principle_name" value="<?php echo @$profile['principle_name'];?>" maxlength='20'/>&nbsp;*</dd>
	   ...
	   <dl style="clear:both;">
			...
			<dd><input type="text" class="raduisSelect" placeholder="<?php echo $address;?>" id="address" value="<?php echo @$profile['address'];?>"/>&nbsp;*</dd>
...
<?php if($this->session->userdata('roleId') ==4 || $this->session->userdata('roleId') ==5 ) {?>
	   <dl style="clear:both;">
			...
			<dd><input type="text" class="raduisSelect" placeholder="<?php echo $zipcode; ?>" id="zipcode" value="<?php echo @$profile[''];?>" onblur="return chkzip();" maxlength='8'/>&nbsp;*</dd>

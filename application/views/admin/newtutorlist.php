...
<table class="data_table">
	...
	foreach ($users as $key => $val) :?>
        <tr id="id_<?php echo $val['uid'];?>">
            ...
            <td class="rw2"><div class="rw2"><?php echo $val['newtutorid'];?></div></td>
            <td class="rw3"><div class="rw3"><?php echo $val['FirstName']. " ".$val['lastName'];?></div></td>
           
			<td class="rw10"><div class="rw10">
			<?php if(@$val['expirydate'] != ""){echo date('Y-m-d',strtotime($val['expirydate']));}else{echo '---';}?></div></td>
			<td class="rw10"><div class="rw10">
            <a href="<?php echo base_url('admin/EditNewTutor/id/'.$val['newtutorid']);?>"><img alt="Edit" src="<?php echo base_url('/images/cm_pencil.png');?>" /></a>
		    <a href="javascript:void(0);" class="delcat" mid="<?php echo $val['uid']; ?>"><img alt="delete" src="<?php echo  base_url('images/cm_cross.png')?>" /></a> 
          </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
...
setTimeout('showmenu("editmenu",1)',1000);
function del(_id){
	if(window.confirm('Are you sure you want to delete this?')){
		$.post('<?echo base_url("admin/DelteNewuser")?>',{id:_id},function(msg){

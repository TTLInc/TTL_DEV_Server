<?php $this->layout->setLayoutData('content_for_layout_title','How It works');?>
<?php $this->layout->setLayoutData('content_for_layout_links','<a href="'.base_url('admin/how_work_add').'">Add new How It works</a>');?>
...
<table class="data_table">
    ...
    <?php foreach ($howItworks as $key => $val) :?>
        <tr id="id_<?php echo $val['id'];?>">
            ...
            <td><img src="<?php echo base_url('uploads/video/images/'.($val['source']?$val['source']:'pdf').'.jpg');?>" width="140px" height="100px"/></td>
            <td>
            <a href="<?php echo base_url('admin/how_work_edit/id/'.$val['id']);?>"><img alt="Edit" src="<?php echo base_url('/images/cm_pencil.png');?>" /></a>
...
function del(_id){
	if(window.confirm('Are you sure you want to delete this?')){
		$.post('<?php echo base_url("admin/how_work_del")?>',{id:_id},function(msg){

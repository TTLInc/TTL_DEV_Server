				...
				<div class="container cf">
					<form>
						<div class="search_block_main01 cf">
							<div class="cm_main01 cf">
								...
								<div class="cm_left05">
									<select name="sortKeys" ng-change="change_order_by(filter_sort_by)" ng-model="filter_sort_by">
								...
								<div class="cm_left06">
									<input value="<?php echo $lSEARCH;?>" type="submit" ng-click="search_data()">
								</div>
							</div>
					...
					<div class="search_result_container">
						...
						<div class="result_2colum_ulli_main cf main_div"  ng-show="filteredData.length!=0" style="display:none;">
							<ul class="cf">
								<li ng-repeat="l in filteredData | filter:{firstName:firstName}| orderBy:filter_sort_by_value | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                                ...
                                <div class="fb-share-div"><div class="fb-share-button fb_iframe_widget" data-href="<?php echo base_url(); ?>" data-layout="button" fb-xfbml-state="rendered" fb-iframe-plugin-query="app_id=&amp;container_width=60&amp;href=http%3A%2F%2F<?php echo str_replace("https://","",str_replace("http://","",base_url())); ?>%2F&amp;layout=button&amp;locale=en_US&amp;sdk=joey"><span style="vertical-align: bottom; width: 60px; height: 20px;"><iframe name="f2a44782f4c6328" allowtransparency="true" allowfullscreen="true" scrolling="no" title="fb:share_button Facebook Social Plugin" style="border: medium none; visibility: visible; width: 60px; height: 20px;" src="https://www.facebook.com/v2.3/plugins/share_button.php?app_id=&amp;channel=http%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter%2Fr%2FP5DLcu0KGJB.js%3Fversion%3D42%23cb%3Df31400928520928%26domain%3D<?php echo str_replace("https://","",str_replace("http://","",base_url())); ?>%26origin%3Dhttp%253A%252F%252F<?php echo str_replace("https://","",str_replace("http://","",base_url())); ?>%252Ff2e38ec59c2123e%26relation%3Dparent.parent&amp;container_width=60&amp;href=http%3A%2F%2F<?php echo str_replace("https://","",str_replace("http://","",base_url())); ?>%2F&amp;layout=button&amp;locale=en_US&amp;sdk=joey" class="" width="1000px" height="1000px" frameborder="0"></iframe></span></div>            </div>
										</div>

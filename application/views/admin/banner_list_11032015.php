<?php $this->layout->setLayoutData('content_for_layout_title','Index Banner List');?>
<?php $this->layout->setLayoutData('content_for_layout_links','<a href="'.base_url('admin/banner_add').'">Add new index banner</a>');?>
...
<table class="data_table">
    ...
    <?php foreach ($banners as $key => $val) :?>
        <tr id="id_<?php echo $val['id'];?>">
            ...
            <td><img src="<?php echo base_url('uploads/images/thumb/'.$val['source']);?>" /></td>
            
            <td><?php echo $val['order'];?></td>
            <td>
            <a href="<?php echo base_url('admin/banner_edit/id/'.$val['id']);?>"><img alt="Edit" src="<?php echo base_url('/images/cm_pencil.png');?>" /></a>
...
setTimeout('showmenu("banner",0)',1000);
function del(_id){
	if(window.confirm('Are you sure you want to delete this?')){
		$.post('<?echo base_url("admin/banner_del")?>',{id:_id},function(msg){

                    ...
                    <div class="group-video-div">
                        <div class="video-dtl">
                            ...
                            <div class="right-videopic">
								...
								<?php }?>
								<?php
								if($groupprofile['fbshare'] != '0'){
								?>
                                <div class="fb-share-button fbshare_31" data-href="<?php echo base_url("user/profile/uid/".$groupprofile['uid']);?>" data-layout="button"></div>
								<?php
								}
								?>
							</div>
                ...
                <div class="dc-box">
                    ...
                    <div class="culture-div">
                        ...
                        <div class="culture-img" id="">
                            ...
                            <img src="<?php echo base_url("uploads/video/images/".$lastvideo['source'].".jpg");?>" alt=""/></a>
                            ...
                            <div class="popup_close_icon_190516"><a class="video_popup190516_close" href="#" id="pausevideo"></a></div>
								<video style="cursor:pointer;background-color:#FFF;" id="popupvideo" class="video-js vjs-default-skin vjs-big-play-centered" width="99.9%" height="" controls preload="auto"  poster="<?php echo base_url("uploads/video/".$lastvideo['source']); ?>.jpg" data-setup="{}">
								<source src="<?php echo base_url("uploads/video/".$lastvideo['source']);?>" type="video/mp4"></source>
				<source src="<?php echo base_url("uploads/video/".$lastvideo['source']);?>" type="video/ogg"></source>
                        ...
                        <div class="culture-txt">
                            <p>
								<?php 
								$content = explode(' ', $lastvideo['desc'], 30);

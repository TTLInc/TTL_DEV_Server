...
<div class="regist">
	...
	<div class="regist_mid_2" style="border-bottom: 0px solid #EBEBEB;">
		<dl id="showInfo" style="color:red;font-size:18px;">
		</dl>
		<!--<dl>
			...
			<dd> 
				...
				<select class="raduisSelect" id="roleId">
					<!--<option value="0" <?php if(@$get['roleId'] == 0 || @$_POST['roleId'] == 0 ) {?>selected<?php }?>><?php echo $student;?></option>
                      ...
                      <!--  added by Ilyas -->
                      <option value="1" <?php if(@$get['roleId'] == 1 || @$_POST['roleId'] == 1 ) {?>selected<?php }?>><?php echo $member;?></option>
                      <!-- end -->
        ...
        <dl <?php echo $member;?> id="membershipInfo">
          ...
          <dd>
                ...
                <input type="radio" id="universal_roleId1" name="universal_roleId" value="1" class="radio" /> <label for="universal_roleId1"><?php echo $arrVal[$multi_lang];?></label></span><br/>
                <span class="male"><?php	$arrVal = $this->lookup_model->getValue('1235', $multi_lang);?>
                <input type="radio" id="universal_roleId2" name="universal_roleId" value="0" class="radio" /> <label for="universal_roleId2"><?php echo $arrVal[$multi_lang];?></label></span>
          </dd>
        </dl>    
	...
	echo $arrVal[$multi_lang];
	?>:</dt>
			<dd><input type="text" class="raduisSelect" placeholder="<?php echo $lFIRST_NAME;?>:" id="firstName" value="<?php echo @$get['firstName'];?>"/> *</dd>
			<dd><input type="text" class="raduisSelect" placeholder="<?php echo $lLAST_NAME;?>:" id="lastName" value="<?php echo @$get['lastName'];?>"/> *</dd>
	...
	echo $arrVal[$multi_lang];
	?>:</dd>
			<dd><span class="male"><input type="radio" name="gender" id="gender1" value="0"/>&nbsp;
			<?php
			$arrVal = $this->lookup_model->getValue('115', $multi_lang);
			echo $arrVal[$multi_lang];
			?></span><br />
			<span class="male"><input type="radio" name="gender" id="gender2" value="1" checked/>&nbsp;
			<?php
...
//					echo '</pre>';
	...
	<div class="regist_mid_2 regist_mid_3" id="loginfo">
		<dl>
			...
			echo $arrVal[$multi_lang];
			?>:</dt>
			<dd><input type="text" class="raduisSelect" placeholder="<?php echo $lEMAIL;?>:" id="email" name="myemail" value="<?php echo @$get['email'];?>"/> *</dd>

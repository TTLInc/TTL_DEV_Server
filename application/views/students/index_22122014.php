            ...
            <div class="sf_padding">
	            ...
	            <form style="display:block;" action="<?php echo Base_url('user/registerDo');?>" method="POST" id="registerForm1">
		            ...
		            <div class="sf_input sf_input_pass" id="cpassred">
						<input autocomplete="off" type="password" value="" name="cpassword" placeholder="<?php echo $lCPASSWORD;?>" size="25" class="txtbox iposition" id="fake_password_1"/>
						<input autocomplete="off" name="cpassword" type="password" size="25" class="txtbox iposition" id="fake_password_1" style="display:none;">
    ...
    <div class="content">
    	<div class="wrapperinner">
            ...
            <div class="buying_credits byd-cdt-sm">
                ...
                <p><!--Prices of tutors and videos vary, but here is the type of value a student gets.--><?php //echo $lBUYING_CREDITS_DESC2;?>Tutors are free to set their own rate. You shop for the tutor with best value at various prices.<br>Here is the type of value you get.</p>
                </div>

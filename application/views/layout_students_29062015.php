...
<?php include_once FCPATH."idle/idle.php";?>
    ...
    <div class="header">
    	<div class="wrapper clearfix">
            ...
            <div class="top_navi">
            	<div class="navi_col top_link_hover">
                	<ul id="top_navi">
                        	...
                        	<ul>
                                <li><a href="<?php echo Base_url("students/index#select_tutor");?>" onClick="showContent('select_tutor'); return false"><!--Selecting a Tutor--><?php echo $lSELECTING_TUTOR;?></a></li>
                                <li><a href="<?php echo Base_url("students/index#buying_credit");?>" onClick="showContent('buying_credit'); return false"><!--Buying Credits--><?php echo $lBUYING_CREDITS;?></a></li>
                                <li><a href="<?php echo Base_url("students/index#guarantee");?>" onClick="showContent('guarantee'); return false"><!--Guarantee--><?php echo $lGUARANTEE?></a></li>
			...
			<!--	<div class="navi_col">
                	<ul id="top_navi" class="tpNav3">
	                	<li><a href="<?php //echo Base_url("affiliate/index");?>" class="top_link tutors"><?php echo "Affiliate";?></a>
                        	<ul>
                               <li><a href="<?php //echo Base_url("affiliate/index");?>"><?php echo $lOVERVIEW;?></a></li>
                                <li><a href="<?php //echo Base_url("affiliate/index#become_trust");?>" onclick="showContent('become_trust'); return false"><?php echo "Become an Affiliate";?></a></li>
                                <li><a href="<?php //echo Base_url("affiliate/index#make_money");?>" onclick="showContent('make_money'); return false"><?php echo "Make Money";?></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div class="navi_col signinbtn">
                    ...
                    <?php if(!$login):?>
				<a href="javascript:void(0)" class="popup-sign sigup-stnt"><?php //echo $lREGISTER_FREE;?><?php echo $lsign_up;?> >></a>
                <?php endif;?>
					<ul id="top_navi" class="tpNav3">
	                	<li><a style="margin-left:30px;color:#3399CC;"  class="viewsite"><?php echo $cnglang;?> ></a>
				...
				<div class="navi_col signinbtn">
     			...
     			<?php */?>
					<div class="welcome_sec"><a href="<?php echo Base_url("user/dashboard");?>"><?php echo $lwelcome; ?>, <?php echo $this->session->userdata['welcomeuser'];?></a>  <em><br></em>  <a id="xOutUser" href="<?php echo Base_url("user/slogout");?>"><?php echo $llogout; ?></a></div>
					<ul id="top_navi" class="tpNav3">
...
if(type==''){
	...
	if(type!='' && type=='guarantee'){
		var padding = 170;
		$('html, body').animate({
			scrollTop: $("#"+type).offset().top + padding
		}, 500);
	}else{
		var padding = 90;
		$('html, body').animate({

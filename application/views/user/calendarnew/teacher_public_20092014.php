...
<div id="divcourseselection" style="display:none;">This is Selection</div>
 <div class="baseBox baseBoxBg clearfix">
		...
		<div id="dialog1" title="" style="display:None;">
			<div class="ratelist">
				<span class="title" style="float:left">This tutor is affiliated with the Language School Program.</span>  
			</div>
			<div class="ratelist">
				<br><br><br><p><span class="title" style="float:left">Select session type</span>  </p>
				<br><br><br>
			...
			<p><input type="button" value="Ok" onclick="closeFunc();"  id="rateButton" class="blu-btn"/>

 ...
 <div class="baseBox baseBoxBg clearfix">
        <div class="content_main fr">
        	<div class="main_inner">                
                    <?php echo profile_menu($linkType,'i_prof',$profile['uid']);?>
                
                <!--/student_prof-->
                <div id="student_prof_Wp">
                    <div class="mod">
                        <div class="hd">
                            <div class="pro_tle tle"><h3>Beepbox</h3></div>
                        </div>
                        <div class="bd">
                            <div class="inbox_mod">
                            	<div class="clearfix">
                                ...
                                <div class="inbox_list inbox_tle">
									...
									<?php else:?>
									<span id="from_firstname"><?php echo @$fresult['firstName']. ' ' .@$fresult['lastName']  ;?></span>
...
.inbox_tle label{ float:left; width:12%;}
	...
	.inbox_list .input{ border:1px solid #dddbdb; width:250px; margin-top:3px; height:28px;  padding:2px 10px; color:#999; font-size:12px;}</style>
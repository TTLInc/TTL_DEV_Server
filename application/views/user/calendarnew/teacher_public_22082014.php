                	...
                	<div class="mod clndr-pg">
                        <div class="hd">
                         <div class="content tle rating">
                                ...
                                <span class="three-why mrbt">3 ways to book your tutor!</span>
                                    ...
                                    <div class="selectboxtest">
                                        <form>
                                            <select name="sspeakinglevel" id="sspeakinglevel">
                                                <option value="naval"><?php echo "Select speaking level";?></option>
...
.clickdisplay{width:147px !important;height:133px;}
	...
	<?php // $markup= "Tutor rate is"; ?>
		$(this).append('<div class="TipCal"><p><?php echo "Talk Now – If icon is green, connect with this tutor in 5 minutes.<br> Book – Book an open timeslot 24 hours in advance. <br> Request – Ask a tutor to open a more convenient time.";?></p></div>');
	}, function () {
		$("div.TipCal").remove();
	});
	});

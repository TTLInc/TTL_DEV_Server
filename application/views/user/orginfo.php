                            	...
                            	<div class="tab-nav">
                                	<ul>
										...
										<li onClick="showHide('con5'); hide();" class="<?php if($currentTab == "col5"){ echo 'active';}?>"><?php echo $schoolDisc;?></li>
										 ...
										 <li onClick="showHide('con7'); hide();" class="<?php if($currentTab == "col7"){ echo 'active';}?>"><?php echo "Messaging"; ?></li>
...
<form name="cancelInfoFrm" id="cancelInfoFrm" action="<?php echo Base_url('user/myInfo');?>" method="POST">
								...
								<?php //echo $currentTab;?>
									...
									<form action="<?php echo Base_url('user/myInfo');?>" method="POST" onsubmit="return validateFormCon1();">
									   ...
									   <div class="cnt-rw">
										...
										<div class="cnt-rw">
                                        	<label><?php echo "Select Tutor Search";?>:</label>
                                           
											<input style="width:30px; margin-top: 0px;" type="Radio" name="sc_select" value="0" <?php if($profile['sc_flag'] == '0'){ ?> checked="checked"<?php } else { }?>><span style="font-size:13px;">Exclude all tutors outside of school</span>
											<input style="width:30px; margin-top: 0px;" type="Radio" name="sc_select" value="1" <?php if($profile['sc_flag'] == '1'){ ?> checked="checked"<?php } else { }?>><span style="font-size:13px;" >Promote tutors to top of search results</span>
									   </div>
									...
									<form action="<?php echo Base_url('user/myInfo');?>" method="POST"  onsubmit="return validateFormCon3();">
                                        ...
                                        <div class="cnt-rw">
											...
											<!--<input   readonly  type="text" value="<?php //echo $encode;?>" id="" name="" />  -->
											<span style="font-size: 18px;color: #037898;"><?php  echo str_replace(" ","-",$encode);?></span>
								   ...
								   <?php if(($profile['roleId'] == 4) ) :?>
									...
									<form action="<?php echo Base_url('user/myInfo');?>" method="POST"  onsubmit="return validateFormCon5();">
                                       ...
                                       <div class="cnt-rw">
                                        	<label class="payment_account" style="width:106px;"><?php echo $schoolDisc;?>:</label>
				...
				?>
							   <div class="sub-cnt" id="con7" style="display:<?php if($currentTab == "col7"){ echo 'block';}else{ echo 'none';}?>;">
			  <div class="bd">							

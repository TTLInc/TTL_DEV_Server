		...
		<?php } else { ?>
			...
			<li id="financial">
				...
				<ul style="display:none;">
					...
					<li id="spayments22"><a  href="<?php echo base_url('admin/rewards');?>"style='cursor:pointer'>Rewards</a></li>
			...
			<li id="Schools">
				...
				<ul style="display:none;">
					...
					<li id="s_layout"><a style='cursor:pointer' href="<?php echo base_url('admin/school_credits');?>">School Credits</a></li>
					<?php }?>

...
<table class="data_table">
	...
	foreach ($users as $key => $val) :?>
        <tr id="id_<?php echo $val['id'];?>">
            ...
            <td class="rw3"><div class="rw3"><?php echo $val['firstName'];?></div></td>
			...
			<td class="rw5"<div class="rw5"><?php echo date('Y-m-d',strtotime($val['add_time']));?></div></td>
		     ...
		     <td class="rw5"<div class="rw5"></div></td>
			 <td class="rw5"<div class="rw5"></div></td>
    ...
    <tfoot>
	<tr><td>total session=<?php echo $tsession?></td><td>total schoolEarning=<?php echo $searning?></td> </tr>
        <tr>
            <td colspan="8">

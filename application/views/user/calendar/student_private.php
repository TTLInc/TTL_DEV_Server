...
$arrVal 	= $this->lookup_model->getValue('899', $multi_lang);	$sessionbook	    = $arrVal[$multi_lang];
//--R&D@Oct-31-2013 : Set Language Variables
 ...
 <div class="baseBox baseBoxBg clearfix">
        ...
        <div class="content_main fr">
			...
			<?php if($uri ==''){?>
                	<div class="mod">
                        <div class="hd">
                            <div class="pro_tle tle"><h3><span class="ltimez" style="width:345px;"><?php echo $lcalender;?> (<?php echo $lLOCAL_TIMEZONE;?>)</span><a href="<?php echo base_url('support/resources/stu'); ?>" style="display:pointer"><span class="svideo"><img style="width:31px;" src="<?php echo base_url('images/blue.jpg');?>"></span></a></h3></div>
                        </div>
						<!--<div class="bd">
	...
	$(function(){
	 ...
	 $("span.lockedtip").hover(function () {
	  ...
	  $("span.svideo").hover(function () {
		  ...
		  $(this).append('<div class="tooltipr"><p><?php echo $sessionbook;?></p></div>');
	    }, function () {
		  $("div.tooltipr").remove();
	    });
...
div.tooltip3 {
 ...
 /* position: absolute;
  ...
  width: 250px; 
  border-radius: 5px;
  line-height:15px;  position: relative;  margin-top:15px !important;  margin-left:-90px !important;
}

...
function grouprate_hide()
{
 document.getElementById("groupRateId").style.display = 'none';
    document.getElementById("imgcol1").style.visibility = 'visible';
    document.getElementById("imgexp1").style.visibility = 'hidden';

}
function grouprate_show()
{
	 document.getElementById("groupRateId").style.display = 'block';
    document.getElementById("imgcol1").style.visibility = 'hidden';
    document.getElementById("imgexp1").style.visibility = 'visible';
}
        ...
        <div class="content_main fr">
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp">
                    <div class="mod">
                        <div class="hd">
                            <div class="content" id="testUpload"><h2 style="margin-top:21px;"><?php echo $lprofile;?></h2></div>
                        </div>
			...
			<?php 
						...
						if($profile["vedio"] !='')
						{
							...
							$videopath = "http://www.thetalklist.com/uploads/video/".$profile["vedio"];
							$imagepath = "http://www.thetalklist.com/video/images/".$profile["vedio"].".jpg";
						}
						else						
						{
							$videopath = "http://www.thetalklist.com/vedio/intro.mp4";
							$imagepath = "http://www.thetalklist.com/images/intro.png";
						}
						 ?>
						...
						<script type="text/javascript">
							...
							<video id="mtest" src="<?php echo $videopath;?>" poster="<?php echo $imagepath;?>"></video>
						<?php } else { ?>
...
<script>
	...
	function createVideo(poster,videoPath){
		...
		proje = projekktor('#player_a', {
			...
			playerFlashMOV:'<?php echo Base_url("vedio/jarisplayer.swf");?>',
			controls: true,
			playlist: [
				{
					0: {src:videoPath, type:'video/mp4'},
					/*1: {src:videoPath, type:'video/mov'},
	...
	$prof = addcslashes($profile['professional'],"\\\'\"\n\r");
      ?>
		...
		createVideo('<?php echo myprofile_video($profile["vedio"],'image');?>','<?php echo myprofile_video($profile["vedio"],'');?>');

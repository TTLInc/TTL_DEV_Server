...
if($_SERVER['HTTP_CLOUDFRONT_FORWARDED_PROTO'] == 'http'){ header("Location: https://www.thetalklist.com");}
...
<link type="image/x-icon" href="https://www.thetalklist.com/images/talklist.ico" rel="shortcut icon">
<?php /*?>
    ...
    <div class="footer">
    	<div class="wrapper clearfix">
            ...
            <div class="footer_links">
            	 <span><!--Copyright--><?php echo $lcopyright;?> <?php echo date("Y") ?> &copy; TheTalkList. &nbsp; &nbsp; <?php echo $lallrightreserve;?><!--All Rights Reserved--></span>

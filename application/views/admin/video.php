<?php $this->layout->setLayoutData('content_for_layout_title','Video list');?>
<?php $this->layout->setLayoutData('content_for_layout_links','<a href="'.base_url('admin/video_add').'">Add new Video</a>');?>
...
<table class="data_table">
    ...
    <?php $j = 0; foreach ($howItworks as $key => $val) :?>
        <tr id="id_<?php echo $val['id'];?>">
            ...
            <td>
            <a href="<?php echo base_url('admin/video_edit/id/'.$val['id']);?>"><img alt="Edit" src="<?php echo base_url('/images/cm_pencil.png');?>" /></a>
...
setTimeout('showmenu("video",0)',1000);
function del(_id){
	if(window.confirm('Are you sure you want to delete this?')){
		$.post('<?php echo Base_url("admin/video_del")?>',{id:_id},function(msg){

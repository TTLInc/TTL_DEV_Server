  ...
  <div class="content_main fr">
    <div class="main_inner">
      ...
      <div id="student_prof_Wp">
        ...
        <div class="mod">
          <div class="bd">
            <ul class="archivedList purchasearchivedList">
              <?php foreach($lessons as $k=>$lesson):?>
              <li source="<?php echo base_url('__PATH__'.$lesson['source']);?>" class="lesson <?php echo $lesson['alid'];?>">
                ...
                <div class="video_pic_intro c666">
                  <div class="video_hd clearfix">
                    ...
                    <span class="fr c939393"><a href="javascript:void(0)" class="delClass" id="<?php echo $lesson['alid'];?>"><em class="ico_op ico_del2 "></em><?php echo $lremovevideo;?></a></span> </div>

        	...
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp" class="cld-txt">
                	...
                	<div class="mod clndr-pg">
                        <div class="hd">
                            <div class="pro_tle tle"><h3><span class="ltimez" style="width:345px;"><?php echo $lcalender;?> (<?php echo $lLOCAL_TIMEZONE;?>)</span><div style="padding-top:0px;float: left;"><a href="<?php echo base_url('support/resources/tut'); ?>" style="display:pointer"></a></div><a class="blu-btn rcr-ses" style="float:right; " href="javascript:void(0);" ><?php echo $lRECURRING_SESSION;?></a></h3></div>
                        </div>

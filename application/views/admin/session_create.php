<?php $this->layout->setLayoutData('content_for_layout_title','Create Group Session');?>
<?php $this->layout->appendFile('javascript',"js/DateTimePicker/jquery.simple-dtpicker.js");?>
<?php $localTimeZone = date_default_timezone_get();?>
<?php if(@$errormsg):?>
...
<?php endif;?>
<form  autocomplete="off" method="post" action="" name="adduserform" id="adduserform" enctype="multipart/form-data">
   <p class="ft_title">Time</p>
    
	
	
	<p class="setft"><input readonly type="text" onclick="showme();" name="startTime" id="startTime"   class="adm_box1" /></p>
	
	<p class="ft_title">Topic</p>
    
	<p class="setft"><input type="text" name="topic" id="topic"   class="adm_box1" /></p>
	
	<p class="ft_title">Tutor1</p>
	  <p class="setft"><input type="text" onkeyup="getall(this.value);"  name="tutora" id="tutora"   class="adm_box1" /></p>
	 <input type="hidden"  name="tutor1" id="tutor1" />
	 <a   style="display:none;width:40px;margin-top:10px;" onclick="closeme();" id="clsme" class="button">Ok</a>
	  <p class="ft_title">Tutor2</p>
	  
	  <p class="setft"><input type="text"   onkeyup="getall1(this.value);" name="tutorb" id="tutorb"   class="adm_box1" /></p>
<input type="hidden"  name="tutor2" id="tutor2">	 
	
	<div id="dynamic" style="width:100%;float:left;clear:both;">
					
						</div><br><br>
 <p class="setft"><a href="javascript:void(0)" onclick="checkform()" class="button">Create</a>
 <a style="margin-left:25px;" href="<?php echo base_url('admin/ListSession');?>"  class="button">Cancel</a>
 </p>
</form>
...
setTimeout('showmenu("Sessionmenu",0)',1000);
</script>

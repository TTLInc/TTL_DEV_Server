...
<script>
	...
	<?php // $markup= "Tutor rate is"; ?>
		$(this).append('<div class="TipCal"><p><?php echo "Now – Realtime in 5 minutes with SMS reminder.<br> Open – Click individual calendar timeslots. <br> Recurring Session – Set batch availability for the current month only.";?></p></div>');
	}, function () {
		$("div.TipCal").remove();
	});
	});
        ...
        <div class="content_main fr">
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp" class="cld-txt">
		            ...
		            -->
					<div class="hd">
                            <div class="pro_tle tle"><h3><span class="ltimez12" style="width:345px;"><?php echo "My Bookings";?></span><div style="padding-top:0px;float: left;"> </div> </h3></div>

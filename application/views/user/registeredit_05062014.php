...
$(document).ready(function(){
	...
	<?php $markup="Enter the amount the school makes on each tutoring session<br> Typical school fee is $2-$3 TheTalkList will add its administration fee onto the resulting fee.";?>  
	...
	<?php $markup="This is a prefix to your unique ID number<BR>It can only contain letters and can be up to 6 characters.";?>  
    <?php // $markup= "Tutor rate is"; ?>
		$(this).append('<div class="tooltipci"><p><?php echo $markup;?></p></div>');
	}, function () {
		$("div.tooltipci").remove();
	...
	<?php $markup="This is the email account where you will be paid on a monthly basis.";?>  
    <?php // $markup= "Tutor rate is"; ?>
		$(this).append('<div class="tooltipci"><p><?php echo $markup;?></p></div>');
	}, function () {
		$("div.tooltipci").remove();
...
<?php if($this->session->userdata('roleId') ==4) {?>
	   <dl style="clear:both; height:120px;" class="clearfix" id="tutRateF">
		...
		<dt class="tmkp">School Markup:<img src="<?php echo Base_url('images/arrow.png') ?>"  /></dt>

...
$arrVal = $this->lookup_model->getValue('1244', $multi_lang);	$lngSpeakLng = $arrVal[$multi_lang];
?>
          ...
          <li>
          		<div class="container">
					<div class="banner_content_main" style="right:0;left:inherit;">
						<h1 style="color:#000000;"><?php echo $lngSpeakLng." ".$lLIKE_A_NATIVE;?></h1>
						<h2 style="color:#000000;"><?php echo $lngRealPpl;?></h2>
						<h3 style="padding:10px 0 40px;text-align:center">
							<a href="javascript:void(0);" class="register_btn" id="register_btn" style="color:#ff7029;"><?php echo $lngletstalk;?></a></h3>
          		...
          		<img src="<?php echo base_url("uploads/images/".$homebanner['source']);?>" alt=""/>
          </li>
		<?php
		}
		?>
...
<!--<div class="banner_main" style="background-image:url(<?php echo base_url("images/home_banner.jpg");?>);background-repeat:no-repeat;background-size:cover;">
	<div class="bgvideo" style="min-height:525px"></div>
	<div class="container">
        <div class="banner_content_main" style="right:0;left:inherit;">
        	<h1 style="color:#000000;"><?php echo $lngSpeakLng." ".$lLIKE_A_NATIVE;?></h1>
            <h2 style="color:#000000;"><?php echo $lngRealPpl;?></h2>
...
<div class="banner-main-mobile" style="background:rgba(0, 0, 0, 0) url('<?php echo base_url("images/home_banner.jpg");?>') no-repeat scroll center center / cover">
	<h1></h1>
    <h2></h2>
    <h3></h3>
...
$(document).ready(function(){
    ...
    pager: ($(".banner-slider li").length > 1) ? true: false,
  });
});
</script>

						...
						<li><a class="top_link2 support" href="<?php echo Base_url("support/faqs");?>"><?php echo $lSUPPORT;?></a>
							<ul style="display: none;">
								...
								<?php if($this->session->userdata('roleId') <4) {?>
										...
										<?php endif;?>
										<?php if($this->session->userdata('roleId') == '' || $this->session->userdata('roleId') == 1): ?>
   ...
   <?php }?>
    ...
    <div class="page_title">
    	<div class="wrapper">
			...
			if($_SERVER['REQUEST_URI'] != '/user/logout' OR $_SERVER['REQUEST_URI'] != '/user/login'){
				
			if($this->session->userdata['roleId'] == 4) {
			?>
			<a href="<?php echo base_url('user/myInfo');?>" title="Settings"><span class="setting-icon"></span></a>
			<?php } else if($this->session->userdata['roleId'] == 5) { ?>
			<a href="<?php echo base_url('user/AffiliateInfo');?>" title="Settings"><span class="setting-icon"></span></a>
			<?php }else {?>
			<a href="<?php echo base_url('user/changeInfo');?>" title="Settings"><span class="setting-icon"></span></a>
			<?php
			}

    ...
    <div class="content">
    	<div class="wrapperinner tutor-pg">
            ...
            <div class="image_right vid_btn">
              ...
              <a style="cursor:pointer;">  <video id="example_video_3" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="auto" width="305" height="187" poster="<?php echo Base_url("images/main/tutor_img.jpg");?>" data-setup='{}'>
            ...
            <div class="image_right vid_btn">
				...
				<video id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="auto" width="305" height="170" poster="<?php echo Base_url("images/main/market_yourself.jpg");?>" data-setup='{}'>

...
?>					
<p id="dc_vid_img_src" style="display:none;"><?php echo $dc_vid_img_src;?> </p>	
<p id="dc_vid_vid_src" style="display:none;"><?php echo $dc_vid_vid_src;?> </p>	
...
<div id="dialog1" title="" style="display:None;">
	<div class="ratelist">
		<span class="title" style="float:left"><?php echo $confirmyourbooking;?> <input type='text' align="center" name='bookingamount' id='bookingamount' value='0' style="color: #3399cc; font-size: 20px; font-weight: normal; margin-bottom: 9px; width:60px; border:0px;" readonly	> <?php echo $creditstext;?></span>
	</div>
	<div class="ratelist">

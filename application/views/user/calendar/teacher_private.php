...
$arrVal 	= $this->lookup_model->getValue('970', $multi_lang);	$clickday	    = $arrVal[$multi_lang];
$arrVal 	= $this->lookup_model->getValue('971', $multi_lang);	$bookorrequest	    = $arrVal[$multi_lang];
                ...
                <div id="teacher_prof_Wp" class="cld-txt">
                	...
                	<div class="mod clndr-pg">
                        <div class="hd">
							...
							<span style="font-size:12pt;color:#010000;font-weight:bold;margin-left:225px;"><?php echo $threeway?> </span><br>
							<div class="click-ttr-sec" style="width:100%;padding-left:51px;margin-top:10px;">
		...
		<table width="720px" height="500px" cellpadding="2" cellspacing="2" border="1">
			...
			<tr>
				...
				<td class="col {$T.day.thisMonth} {$T.day.today}">
					<a style="cursor:pointer;color:black;"  onclick="disptslot({$T.day.day},{$T.day.month});">

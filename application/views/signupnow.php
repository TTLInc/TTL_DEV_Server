...
?>
<div class="signupnow_page_only">
<div class="banner_main" style="background-image:url(<?php echo $homeImgSrc;?>);background-repeat:no-repeat;background-size:cover;">
...
<div class="banner-main-mobile">
    ...
    <div class="banner_search_right">
    <?php if(!$login):?>
		<img src="<?php echo base_url("images/fb-signin.png");?>" id="facebook" style='cursor:pointer;' />
	...
	<div class="container cf">
        ...
        <div class="video_main videomain2">
            <?php
                $ua = strtolower($_SERVER['HTTP_USER_AGENT']);
                if((stripos($ua,'android') !== false) or (strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPod'))) { // && stripos($ua,'mobile') !== false) {?>
                    <iframe width="100%" height="219" src="<?php echo base_url("uploads/video/ttl-experience_v3.mp4");?>" frameborder="0" allowfullscreen></iframe>
                <?php }
                else 
                {?>

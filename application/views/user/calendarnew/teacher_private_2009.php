        ...
        <div class="content_main fr">
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp" class="cld-txt">
		            ...
		            -->
					<div class="hd">
                            <div class="pro_tle tle"><h3><span class="ltimez12" style="width:345px;"><?php echo $MyBooking;?></span><div style="padding-top:0px;float: left;"> </div> </h3></div>
								...
								<li>
									...
									<div class="rating_ct">
										...
										<div class="classes_info clearfix f12 fb">
											<span class="fl">
												<?php echo $class['firstName'] ?> <br> <br><?php echo  hiaOutTime($class['startTime']) ;?>
											</span>
											...
											<span class="c06a0c1" id="join-vee-session">
												...
												<?php } else{?>
												<span class="Disjoin"><a class="grey-btn disable-join" id="class_e_<?php echo $class['id']; ?>"  ><?php echo $ljoin_vee_session;?></a></span>
												<?php }?>
									...
									<div class="rating_ct">
										...
										<div class="classes_info clearfix f12 fb">
											...
											<span class="c06a0c1" id="join-vee-session">
												...
												<a class="blu-btn btn-block" id="class_d_<?php echo $class['id']; ?>"  href="javascript:void(0);"><span  theClassId='<?php echo $class['id'];?>' class="delClass" style="color:white" id="class_t_<?php echo $class['id']; ?>" ><?php echo "Cancel";?></span></a>
												<?php } else { ?>
												...
												<?php } else{?>
												<span class="Disjoin btn-block"><a class="grey-btn disable-join" id="class_e_<?php echo $class['id']; ?>"  ><?php echo $ljoin_vee_session;?></a></span>
												<?php }?>
												<a class="blu-btn btn-block" id="class_d_<?php echo $class['id']; ?>"  href="javascript:void(0);"><span theClassId='<?php echo $class['id'];?>' style="color:white" class="delClass" id="class_t_<?php echo $class['id']; ?>" ><?php echo "Cancel";?></span></a>
												<?php } ?>
											</span>
										</div>
									</div>

<?php $this->layout->setLayoutData('content_for_layout_title','Edit Message');?>
...
<form method="post" action="" name="editVideoform" id="editVideoform" enctype="multipart/form-data">
    ...
    <p class="setft">
		<input type="text" name="text" id="text" value="<?php echo $ad['text'];?>"  class="adm_box1" />
	</p>
    
	<p class="ft_title">Image</p>
    <p class="setft">
        <input type="file" name="image_file" id="image_file" value="<?php echo $ad['image'];?>"  class="adm_box1" />
    </p>
	
	<!--<p class="ft_title">Video</p>
    <p class="setft">
        <input type="file" name="video_file" id="video_file" value="<?php echo $ad['source'];?>"  class="adm_box1" />
    </p>-->
...
setTimeout('showmenu("messages",1)',1000);
</script>
</body>
</html>
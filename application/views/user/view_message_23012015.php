                        ...
                        <div class="bd">
                            <div class="inbox_mod">
                                ...
                                <div class="inbox_list inbox_tle">
									...
									<?php else:?>
									<span id="from_firstname"><?php if($fullname==@$fresult['firstName']. ' ' .@$fresult['lastName']){ echo 'TalkMaster BlueBob';}else{  echo @$fresult['firstName']. ' ' .@$fresult['lastName'];}?><?php //echo @$fresult['firstName']. ' ' .@$fresult['lastName']  ;?></span>

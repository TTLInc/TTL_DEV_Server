<?php $this->layout->setLayoutData('content_for_layout_title','Member Edit');
?>
...
<form method="post" action="" name="edituserform" id="edituserform" enctype="multipart/form-data">
  ...
  <?php } ?>
	...
	?>
	<p class="setft"><input type="text" name="cur_bal" id="cur_bal" value="<?php echo $user['money'];?>"  class="adm_box1" <?php echo $disabled;?>/></p>
...
setTimeout('showmenu("mpayments",5)',1000);
</script>
</body>
</html>
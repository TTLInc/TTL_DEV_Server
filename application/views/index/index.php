...
<link rel="canonical" href="https://www.thetalklist.com/" />
<?php
$multi_lang = 'en';
if(!isset($_SESSION)) {
     session_start();
...
<script src="<?php echo base_url('js/home/amazingcarousel.js');?>"></script>
<script src="<?php echo base_url('js/home/initcarousel-1.js');?>"></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url('js/home/initcarousel-1.css');?>">	
...
<style>
.banner_main, .bgvideo{ height:475px;}
span.NextGroup {
	color: #FFFFFF;
...
?>
<div class="banner_main index-banner" style="background-image:url(<?php echo $homeImgSrc;?>);background-repeat:no-repeat;background-size:cover;">
	<div class="bgvideo" style="min-height:395px"></div>
	<div class="container">
        <div class="banner_content_main" style="right:0;">		
			<!--<div class="banner_video_img05">
            
            <div class="videohome_popup05" id="whatwould03">
        	<div class="popup_close_icon_050516"><a href="#" class="whatwould03_close" id="pausevideo"></a></div>
        <?php
			if(count($topvideo) > 0){
			?>
			 <div class="video_main_top" id="landing_vid_src">
                <video style="cursor:pointer;background-color:#FFF;" id="example_video_top" class="video-js vjs-default-skin vjs-big-play-centered" width="99.9%" height="" controls preload="auto"  poster="<?php echo base_url("uploads/video/images/".$topvideo[0]['source'].".jpg");?>" data-setup="{}">
					
					<?php
					$landing_vid_src = '';
					if(file_exists(FCPATH."uploads/video/".$topvideo[0]['source'])){
						$landing_vid_src = base_url("uploads/video/".$topvideo[0]['source']);
					}else{
						$landing_vid_src = "http://52.8.248.161/uploads/video/".$topvideo[0]['source'];
					}
					?>
					<?php /*<source src="<?php echo base_url("uploads/video/".$topvideo[0]['source']);?>" type='video/mp4'/>*/ ?>
					<source src="<?php echo $landing_vid_src;?>" type='video/mp4'/>
				</video>
				<?php if(!$login):?>
                <div class="popup_signup_btn_main">			
				<div class="signup_btn"><a class="whatwould03_close register_btn" href="#" id='signupform'>Sign Up</a></div>
                <span>for free to see more…</span>
                </div>
				<?php endif;?>
			</div>
			<?php
			...
			<span class="freevideolibrary"><?php echo $freevideos; ?></span>
            
             <?php
			if(count($topvideo) > 0){
			?>
            <a class="whatwould03_open" href="#whatwould03">
            <div class="freevideolibrary_video_icon"><img src="<?php echo base_url("images/")?>/video_icon03062016.png" alt="video"></div>
            
            <?php
			$landing_vid_img = '';
			if(file_exists(FCPATH."uploads/video/images/".$topvideo[0]['source'].".jpg")){
				$landing_vid_img = base_url("uploads/video/images/".$topvideo[0]['source'].".jpg");
			}else{
				$landing_vid_img = "http://52.8.248.161/uploads/video/".$topvideo[0]['source'].".jpg";
			}
			?>
			<img src="<?php echo $landing_vid_img;?>" alt="video" id="hmpgvid">
			<?php /*<img src="<?php echo base_url("uploads/video/images/".$topvideo[0]['source'].".jpg");?>" alt="video">*/ ?>
        	...
        	<div class='hbclass'>
				<?php
				$arrVal = $this->lookup_model->getValue($getValueOfRealPpl, $multi_lang);
				$lngRealPpl= $arrVal[$multi_lang];
				echo $lngRealPpl;
				?>
			</div>
            
				<div style="color:#FFF;font-size:22px;text-align:center;" ></div>
				<div class="banner_search_right">
				<?php if(!$login):?>
					<br>
					<a href="<?php echo $fblogin_url; ?>"><img src="<?php echo base_url("images/fb-signin.png");?>" id="facebook" style='cursor:pointer;' /></a>
...
<?php if($multi_lang == 'es'){ ?><div class="es-banner-main-mobile"><?php }else{ ?><div class="banner-main-mobile"><?php } ?>
    <div class="banner_search_right">
    <?php if(!$login):?>
		<a href="<?php echo $fblogin_url; ?>"><img src="<?php echo base_url("images/fb-signin.png");?>" id="facebook" style='cursor:pointer;' /></a>
...
<div class="online_blue_box">
	<div class='hclass'><?php echo $lngOnlinelang;?><br><?php echo $lngGuaranted;?></div>
</div>
<div class="how_it_works_main">
	<div class='hclass'><?php echo $HowItwork;?></div>
    <div class="container cf">
    	<div class="how_it_works_left01">
        	...
        	<a href="<?php echo base_url('search/search'); ?>"><img src="<?php echo base_url("images/search01_img.png");?>" alt="<?php echo $lsearch;?>"></a>
      ...
      <div class="how_it_works_left02">
        ...
        <a href="<?php echo base_url('search/search'); ?>"><img src="<?php echo base_url("images/search02_img.png");?>" alt="<?php echo $lschedule;?>"></a>
      ...
      <div class="how_it_works_left03">
        ...
        <a href="<?php echo base_url('testveesession/testVeeSession'); ?>"><img src="<?php echo base_url("images/search03_img.png");?>" alt=""></a>
        <h3><?php echo $lngEnjoyVideo;?></h3>
      </div>
    </div>
</div>
<div class="howit-video cf">
	<div class="container cf">
        <?php
		$ua = strtolower($_SERVER['HTTP_USER_AGENT']);	
		if((stripos($ua,'android') !== false) or (strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPod'))) {
        ...
        <!--<div class="video_main">
            <?php
                // && stripos($ua,'mobile') !== false) {?>
                   <iframe width="100%" height="219" src="https://www.youtube.com/embed/YpJvvE1NPiA" frameborder="0" allowfullscreen></iframe>
                <video style="cursor:pointer;background-color:#FFF;" id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" width="100%" height="219" controls preload="auto"  poster="<?php echo Base_url("images/main/rgt-video-img.jpg");?>" data-setup="{}">
                     <source src="<?php echo base_url("vedio/how_it_works.ogg");?>" type='video/ogg' />
				</video>
        </div>-->
		<?php }?>
        <!--<div class="video_main videomain2">
            <?php
                $ua = strtolower($_SERVER['HTTP_USER_AGENT']);
                if((stripos($ua,'android') !== false) or (strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPod'))) { // && stripos($ua,'mobile') !== false) {?>
                   <?php if($multi_lang == 'es'){ ?>
						<iframe width="100%" height="219" src="https://www.youtube.com/embed/Y7yQjKyNk-o?rel=0" frameborder="0" allowfullscreen></iframe>
					<?php }else{ ?>
						<iframe width="100%" height="219" src="https://www.youtube.com/embed/PVlnUKWTNjY?rel=0" frameborder="0" allowfullscreen></iframe>
					<?php } ?>
                <?php }
                else 
                {?>
		...
		<div id="amazingcarousel-container-1">
			<div id="amazingcarousel-1" style="display:none;position:relative;width:100%;max-width:560px;margin:0px auto 0px;">
				<div class="amazingcarousel-list-container">
					<ul class="amazingcarousel-list">
						<li class="amazingcarousel-item">
							<div class="amazingcarousel-item-container">
								<div class="amazingcarousel-image">
								<iframe width="510" height="315" src="https://www.youtube.com/embed/PVlnUKWTNjY?rel=0" frameborder="0" allowfullscreen></iframe>
								</div>
								</div>
												</li>
												<li class="amazingcarousel-item">
													<div class="amazingcarousel-item-container">
								<div class="amazingcarousel-image">
								<iframe width="510" height="315" src="https://www.youtube.com/embed/F1fwfaK2pTg?rel=0" frameborder="0" allowfullscreen></iframe></div>
								</div>
												</li>
												<li class="amazingcarousel-item">
													<div class="amazingcarousel-item-container">
								<div class="amazingcarousel-image">
								<iframe width="510" height="315" src="https://www.youtube.com/embed/YpJvvE1NPiA?rel=0" frameborder="0" allowfullscreen></iframe></div>
								</div>
						</li>
					</ul>
...
<div class="free_grsession_main">
	<div class='hclass'><?php echo $lngUnqSys;?></div>
...
<div class="container cercal-text">
  <div class='hbrowseclass'><a href="<?php echo base_url('search/search'); ?>"><?php echo $bhrowswtutor;?></a></div>
    <ul>
    	<li class="text1"><a href="<?php echo base_url('search/search?langInput1=English&keywords=business&langInput2=0&frm=dash'); ?>"><h2 id="demo1"><?php echo $lngBus;?></h2><img src="<?php echo base_url("images/business_img.png");?>" alt="<?php echo $lngBus;?>"></a></li>
        <li><a href="<?php echo base_url('search/search?langInput1=English&keywords=college&langInput2=0&frm=dash'); ?>"><h2 id="demo2"><?php echo $lngAca;?></h2><img src="<?php echo base_url("images/academics_img.png");?>" alt="<?php echo $lngAca;?>"/></a></li>
        <li><a href="<?php echo base_url('search/search?langInput1=English&keywords=technology&langInput2=0&frm=dash'); ?>"><h2 id="demo3"><?php echo $lngTech;?></h2><img src="<?php echo base_url("images/technology_img.png");?>" alt="<?php echo $lngTech;?>"></a></li>
        <li><a href="<?php echo base_url('search/search?langInput1=English&keywords=travel&langInput2=0&frm=dash'); ?>"><h2 id="demo4"><?php echo $lngTravel;?></h2><img src="<?php echo base_url("images/travel_img.png");?>" alt="<?php echo $lngTravel;?>"></a></li>
        <li><a href="<?php echo base_url('search/search?langInput1=English&keywords=culture&langInput2=0&frm=dash'); ?>"><h2 id="demo5"><?php echo $lngPop;?></h2><img src="<?php echo base_url("images/pop_culture_img.png");?>" alt="<?php echo $lngPop;?>"></a></li>
    </ul>
	<?php if(!$login):?>        
...
<div class="our_grey_box">
	...
	<h1>Learn American English Online</h1>
</div>
...
<div class="">
	<div class="partner_section_main cf">
        ...
        <div class="partner_section_left03">
   	    <img src="<?php echo base_url('images/Aiesec black.png');?>" alt="World's largest">
...
$("#pausevideo").click(function(){ 
    //$('#example_video_top').removeAttr("autoplay");
	var video = document.getElementById("example_video_top_html5_api");
	video.pause();
});
...
$(".popup_close_icon_050516").click(function(){ 
    $('#example_video_top').removeAttr("autoplay");
}); 
...
$(document).ready(function (event) {
	...
	$('#whatwould03').popup({
	 ...
	 $(".example_video_top").hide();
	//$(".whatwould03_close").overlay().close();
});
</script>
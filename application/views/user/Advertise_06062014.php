...
$.ajax({
					...
					{
					 var tst='dd';				
					$("#dynamic").append('<span style="float: left; margin-left: -31px; font-size: 12px; clear: both; width: 100%;"><p class="by-btn" style="float:left;"><a  style="cursor:pointer;" id="" onclick="test();"><?php echo $dwnld;?></a></p> <b style="float: left; margin-top: 11px; margin-left: 10px;"><?php echo $select; ?> </b></span>');		
					}

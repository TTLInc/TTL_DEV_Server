...
<table class="data_table">
	...
	foreach ($users as $key => $val) :?>	
        <?php		
			/*$prmsql = "UPDATE profile set money=".$val['endbal']." WHERE uid=".$val['id']; 
			$query = $this->db->query($prmsql);*/
		?>
			...
			<td class="rw10"><div class="rw10">
			<?php $val['BigBal']=number_format($val['BigBal'],2,'.','');
			if($val['BigBal'] <0 ){ echo $val['BigBal'] = number_format(0,2,'.',''); }else{ echo $val['BigBal']; }
			?>
			</div></td>
			<td class="rw10"><div class="rw10">
			<?php echo $val['addstu']=number_format($val['addstu'],2,'.','');?>
			</div></td>
			<td class="rw10"><div class="rw10">
			<?php echo $val['sub']=number_format($val['sub'],2,'.','');?>
			</div></td>
			<td class="rw10"><div class="rw10">
			<?php 
				echo $val['endbal'];

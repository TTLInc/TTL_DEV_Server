        	...
        	<div class="main_inner">
                ...
                <div id="student_prof_Wp">
                    <div class="mod">
                            ...
                            <div class="content tle"><h2><?php echo $beepbox; ?> <a style="font-size:14px;" class="msg-lnk" href="<?php echo base_url('user/message_setting');?>"><?php echo $lmsgsettings;?></a></h2></div>
						...
						-->
							...
							<table class="history_table f14">
								<thead>
									<tr><th width="3%"><!--<input type="checkbox"  class="idAll">--></th><th><?php echo $subjecttext; ?></th><th><?php echo $fromtxt; ?></th><th><?php echo $datetxt; ?></th></tr>
								</thead>
								<tbody id="nbmesg">
									<?php
									...
									<tr class="read<?php echo $message['isRead'];?> " inboxId="<?php echo $message['id'];?>">
										...
										<?php
										$cquery = "select firstName from profile where uid=".$message['fId'];
										...
										<td>
											...
											TalkMaster BlueBob
											<?php else:?>
											<p <?php if($message['isRead']) { echo "style='color:#000000;'"; } else{ echo "style='color:#000000;font-weight:bold;'"; } ?>><?php if($fullname==$message['fId']){ echo 'TalkMaster BlueBob';}else{  echo $result['firstName'];}?></p>

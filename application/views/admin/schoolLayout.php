...
<table class="data_table">
    <thead>
        <tr>
            ...
            <th class="rw9"><div class="rw9">Unique Landing Page</div></th>
			 <th class="rw9"><div class="rw9">Curriculum </div></th>
        </tr>
    </thead>
	...
	foreach ($users as $key => $val) :?>
        <tr id="id_<?php echo $val['uid'];?>">
            ...
            <td class="rw2"><div class="rw2"><?php echo $val['uid'];?></div></td>
           ...
           <td> <input type="checkbox" onclick="checkMe(<?php echo $val['uid']?>);" <?php if ($val['s_layout'] ==1) { ?> checked <?php }?> value="<?php echo $val['s_layout'];?>"> </td>
			 <td> <input type="checkbox" onclick="UpdateCurriculum(<?php echo $val['uid']?>);" <?php if ($val['curriculum'] ==1) { ?> checked <?php }?> value="<?php echo $val['curriculum'];?>"> </td> 
...
setTimeout('showmenu("Schools",4)',1000);
...
function UpdateCurriculum(ids)
{ 
	$.post('<?echo base_url("admin/UpdateCurriculum")?>',{id:ids},function( ){

        	...
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp" class="cld-txt">
                	...
                	<div class="mod clndr-pg">
                        <div class="hd">
                            <div class="pro_tle tle"><h3><span class="ltimez"><?php echo $lcalender;?> (<?php echo $lLOCAL_TIMEZONE;?>)</span><div style="padding-top:0px;float: right;"><a class="blu-btn rcr-ses" style="float:left;" href="javascript:void(0);" ><?php echo $lRECURRING_SESSION;?></a></div></h3></div>
                        </div>
                    ...
                    <div class="mod">
                        ...
                        <div class="bd">							
							<ul class="ratings_list2">
								<a class="aqua_btn norBtn redRadiusBtn2 w140 f12 vess-btn" href="<?php echo base_url('testveesession/testVeeSession');?>"><?php echo "Test Vee-session";?></a>
							</ul>
							<p class="previewbutton"><?php echo $vtext;?> <a href="http://www.mozilla.org/en-US/firefox/new/" target="_blank" >Firefox,</a> <a href="https://www.google.com/intl/en/chrome/browser/?hl=en&brand=CHMA&utm_campaign=en&utm_source=en-IN-ha-bk&utm_medium=ha&utm_term=%2Bchrome" target="_blank" >Chrome,</a> and <a href="http://www.opera.com/computer/windows" target="_blank" >Opera.</a> <?php echo $clickupgradetext;?></p>
		...
		$('.timeSlot').live('click',
			function(){  
				...
				//alert('hrer');
					...
					$(this).html('<?php echo "Click to confirm"; ?>');
					...
					$.each(s.rows,function(k,v){
						...
						if(s.rows[k].stid!='undefined' && typeof(v.sid)=='undefined' ){
							//status = '<?php echo "Confirm";?>';
							 ...
							 status = '<?php echo "Click to confirm";?>';
							 //$('.timeSlot[eregkey='+_k+']').addClass('Confirm');
							//$
						}

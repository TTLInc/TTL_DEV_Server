...
<?php
if($_SERVER['REQUEST_URI'] == '/www.thetalklist.com/user/account/1'){
...
<script>alert("Your account has been made invisible to the membership. Either you have an incomplete profile (photo, video greeting, bio, rate, and open calendar sessions) or you have inappropriate content. \n\nPlease edit so we can maintain a complete and professional profile for all visible tutors. Once updated, send a message to support@thetalklist.com to activate your profile.");</script>
<style>
.mod 
{
	display:none;
...
<div class="baseBox baseBoxBg clearfix">
    	...
    	<div class="main_inner">
            ...
            <div id="student_prof_Wp">
            	<div class="mod">
                    ...
                    <div class="content tle"><h2><?php echo $lcurrentbalance;?>: (<?php if($profile['money'] < 0){ echo "0.00";}else{ echo $profile['money']; }?> <?php //echo $credittext; ?>)</h2> </div>
					<?php } else{?>
					<div class="content tle"><h2>Tutors</h2></div>
					<?php }?>
                ...
                <div class="mod">
					<?php if($profile['roleId'] == 0){ ?>
                    <div class="content tle"><h2><?php if($roleId != 0){ echo $upgradeaccounttext; } else { echo $lloadaccount; } ?> <span class="payment" style="float:right; margin:10px 25px 0 0;"><img src="<?php echo base_url('images/arrow.png');?>" alt="ed"></span> </h2></div>
                    <?php } ?>
                    <div class="bd">
						...
						<div class="load-acc">
							<ul>
								...
								<li class="active">
									...
									<p class="by-btn"><a href="javascript:void(0);" onclick="sbtform('1000');"><?php echo $lbuynow; ?></a></p>
								</li>
                ...
                <div class="mod">
                    ...
                    <span style="padding-left:10px;"><?php echo $selectpaidtext; ?></span>
			...
			<div class="mod">
				<div class="content tle"><h2><?php echo $upgradeaccounttext; ?><span class="payment" style="float:right; margin:10px 25px 0 0;"><img src="<?php echo base_url('images/arrow.png');?>" alt="ed"></span> </h2></div>
                    <div class="bd">
	...
	<div class="content_main fr">
        ...
        <div id="student_prof_Wp">
            <div class="mod">
				<div class="content tle"><h2>Students</h2></div>
				<div class="bd">
					<?php if(count($affiliate) > 0){ ?>
					<span style="font-size:25px;">Statements &nbsp; &nbsp;</span>
					<input type="text" name="stre" id="stre"  class="adm_box1"/>
					...
					<table class="history_table f14" id="ttest">
					   ...
					   <p style="float:right;font-size:25px;">Total Affiliate Commissions:<?php echo $cmn;?></p>
				<?php }else {?>
				<br><br><br><br><p  align="center"  style="font-size:14px;">
				Welcome to TheTalkList Affiliate Program!</p>
				<p style="font-size:14px;">As you see students joining TheTalkList, their records will appear on this page where you can track your affiliate fees.  To get started, you need two things:</p>
                  <p style="font-size:14px;">1. Your affiliate link seen under your name</p>
				   <p style="font-size:14px;">2. Advertisements to place in your marketing channels</p>
					<p style="font-size:14px;">Click on the Ads icon above to see a selection of ads in different languages.
					</p><p style="font-size:14px;">You can Right/Click any ad and save the JPG image to your local system.  You may also make a request for a specific ad message or size to: affiliate@thetalklist.com.</p>
					<p style="font-size:14px;">You’ll be paid to your PayPal account at the end of each month.
				</p>
				<?php } ?>
				</div>
			</div>
	...
	<div class="content_main fr">
        ...
        <div id="student_prof_Wp">
            	<div class="mod" id="test">
					 ...
					 <div class="content tle"><h2>Tutors</h2> </div>
					<a style="float:left;" class="adbtn" href="<?php echo base_url('user/tsearch') ?>">Add New</a>
					 ...
					 <table class="history_table f14" id="ttest">
						   ...
						   <!--<td><?php 
								//echo date('Y-m-d ',strtotime($tutor[$i]['add_time']));
								//echo $tutor[$i]['add_time'];
						    ?></td>-->
							<?php if($tutor[$i]['firstName'] !=''){?>
							<td><a class="dicon" href="#" style="cursor:pointer;" onclick="deltutor(<?php echo $tutor[$i]['uid'] ?>,<?php echo $sid;?>);"><img src="<?php echo base_url('images/cbtn.jpg')?>"></a></td>
						   <?php }?>	
						   </tr>
						   <?php }?>
						   </tbody>
						   </table>
						     <span style="font-size:15px;">Sessions: <?php if($tutorforaccount[0]['total1']!='')echo $tutorforaccount[0]['total1'];else echo '0' ?> </span>	
						   <span style="font-size:15px;margin-left:25px;">Tutor Earnings: <?php echo ($tutorforaccount[0]['totalfee1']-$tutorforaccount[0]['total1']*$sch)?></span>	
						   <span style="font-size:15px;margin-left:25px;">School tutor Earnings:<?php echo $tutorforaccount[0]['total1']*$sch;?> </span>
						  <span style="font-size:15px;margin-left:25px;">School student earnings:<?php if(count($samout)>0){echo $samout[0]['earning'];};?></span>	
						   

					<?php }else {?>
					<br><br><br><br><p  align="center"  style="font-size:14px;color:red;">You have no tutors added to your school</p>
					<?php } ?>
                 ...
                 <div class="mod">
					...
					<div class="bd">
					 ...
					 <div class="history_tle f18 agnC">
                               <a href="?type=month" <?php if($filterType=='month'):?>class="history"<?php endif;?> ><?php echo "Monthly";?></a> / 
                               <a href="?type=year" <?php if($filterType=='year'):?>class="history"<?php endif;?> ><?php echo "Annualy";?></a> / 
                               <a href="?type=all" <?php if($filterType=='all'):?>class="history"<?php endif;?> ><?php echo "Total";?></a>
					 ...
					 <table class="history_table f14" id="ttest">
								<thead>
									<tr><th>Student</th><th>Tutor</th><th>Total Session</th></tr>
								</thead>
					       <tbody id="nbmesg">
						   ...
						   <td><?php if($students[$i]['scnt'] > 0) echo $students[$i]['scnt'] ;?></td>
						   <!--<td><?php 
								//echo date('Y-m-d ',strtotime($tutor[$i]['add_time']));
								//echo $tutor[$i]['add_time'];
						    ?></td>-->
...
var a=document.getElementById('stre').value;
var url="<?php echo base_url('user/genpdf')?>"+"/"+a;
//window.location.href="<?php echo base_url('user/genpdf')?>"+"/"+a;
...
//window.location.href="<?php echo base_url('user/tutorpdf')?>"+"/"+a;
}
function deltutor(uid,sid)
{

var a= confirm("Are you sure you want to delete this tutor?");
if(a)
{
   var cupdate = uid;
...
$(function(){
	...
	$("#savepayment").click(function(){
		...
		if(payment_account==''){
			alert('please input your payment account');
			return false;
...
function sbtform(money, month){
	...
	$('#bs_money').val(money);
	var credit = 100;
	if(money == 300) credit = 303;
	if(money == 500) credit = 510;
...
$(document).ready(function () {
			//$("td.abc").addClass("clickdisplay");
			  ...
			  <?php } else if($roleId == 0){ ?>
			   ...
			   $("a.dicon").hover(function () {
			 	$(this).append("<div class='tooltip-payment tooltip-payment2'><p><?php echo "Delete tutor from school community"; ?></p></div>");
				}, function () {
				$("div.tooltip-payment").remove();
			  });
			  
			  $("a.pdf").hover(function () {
			 	$(this).append("<div class='tooltip-payment'><p><?php echo "Statements"; ?></p></div>");
				}, function () {
				$("div.tooltip-payment").remove();
			  });
    ...
    /*$('#id_radio2').click(function () {
        ...
        $('#div4, #div5, #div6').show('slow');
		$('#dollar4, #dollar5, #dollar6').show('slow');
		$('#dollar1, #dollar2, #dollar3').hide('slow');
		$('.email-rw').show('slow');
		$('#paytext').hide('slow');
		$('#alitext').show('slow');
    });*/
...
$("#stre").datepicker({ dateFormat: 'yy-mm-dd' } );
setTimeout('showmenu("ad1",0)',1000);
</script>
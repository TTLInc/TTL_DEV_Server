...
$arrVal = $this->lookup_model->getValue('1207', $multi_lang);
$Notes = $arrVal[$multi_lang];

$arrVal = $this->lookup_model->getValue('1229', $multi_lang);
$PleaseConfirm = $arrVal[$multi_lang];
        	...
        	<div class="main_inner">
                ...
                <div id="student_prof_Wp">
                    <div class="mod">
							...
							<a style="<?php if($ul=='inbox' || $ul=='message_send'){ ?>font-weight:bold;<?php }?>font-size:19px;margin-left:10px;margin-right:10px;" class="msg-lnk" href="<?php echo base_url('user/inbox');?>"><?php echo $Inbox;?></a>

...
<!-- Facebook tracking pixel code End-->
...
<div class="header">
    ...
    <div class="page_title">
		...
		<option <?php if($this->uri->segment(5)>0){?> selected    <?php }?> value="0">Curriculum</option>
		<option <?php if($this->uri->segment(5) <=0){?> selected    <?php }?> value="1">Conversation</option>
		</select>
	  <?php //}?>

...
//if($_SERVER["SERVER_NAME"] == "dev.thetalklist.com"){ header("Location: https://cdn-dev.thetalklist.com"); }
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('css/style-interviewpg.css');?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('css/responsive-interviewpg.css');?>">
<!--CSS END -->
...
<![endif]-->
<script>
    videojs.options.flash.swf = "<?php echo base_url()?>vedio/video-js.swf";
</script>
<script>
...
{
//alert('here');
/*if(s == 'roleId1_input_4')

{
$('#firstName1').attr("placeholder","<?php echo $schoolname;?>");
}
else if(s == 'roleId1_input_5')
{
$('#firstName1').attr("placeholder","<?php echo $affiliatename;?>");
}
else
{
document.getElementsByName('firstName1')[0].placeholder='<?php echo $lFIRSTNAME?>';
}*/
}
...
<body onLoad="wireUpEvents()" class="ly-index nw-landingpg"><?php include_once FCPATH."idle/idle.php";?>
<div id="gsessionDialog" style="display:None;">
  <div style="float:right" class="close_btn"> <img style="cursor:pointer;" width="30px;" onClick="closegsession();" src="<?php echo base_url('images/close-btn.png')?>"> </div>
  <div class="ratelist"> <span class="title" style="float:left;margin-top:10px;margin-bottom:15px;font-size:16px;"><?php echo $areyoualready;?></span> </div>
  <br>
  <br>
  <br>
  <p>
    <input type="button" value="Yes" onClick="goLogin();" id="buttonOk" class="blu-btn"/>
...
<div class="header_login" id="header_login">
  <div class="wrapper">
    <form action="<?php echo Base_url("user/login");?>" method="post" id="formLogin">
      <div class="top_login clearfix"> <span class="log_text">
        <!--Sign In-->
        <?php echo $SIGN_IN;?></span>
        <div class="log_input">
          <input name="email" placeholder="<?php echo $lEMAIL;?>" type="text" id="email">
        </div>
        <div class="log_input">
        ...
        <a href="<?php echo base_url('user/forget');?>" class="forgot_pass">
        <!--Forgot password-->
        <?php echo $lforget;?></a> <a href="#" class="close_btn" id="close_btn"></a> </div>
    </form>
  </div>
</div>
<?php endif;?>
  ...
  <div class="signup_form" id="signup_form1">
    <div class="sf_padding">
      ...
      <form style="display:block;" action="<?php echo Base_url('user/registerDo');?>" method="POST" id="registerForm1">
		<input type="hidden" name="frmmodule" id="frmmodule" value="<?php echo $this->uri->segment(1)?>" />
        <div class="sf_select" id="rselect"> <span class="select_box_holder sel_width_215">
          ...
          </span> <span id="roleId_required" style="color:red;display:none;"><b>Select</b></span> <span style="color:red;display:none;font-size:14px;margin-top:40px;" id="rid1"><?php echo $selectuser; ?></span> </div>
        <div class="sf_input" id="fnamered">
          ...
          <span id="firstName_required" style="color:red;display:none;"><b>Firstname is required</b></span> <span style="color:red;display:none;font-size:14px;margin-top:10px;" id="fname1"><?php echo $enterfname;?></span> </div>
        <div class="sf_input" id="ered">
          ...
          <span id="email_required" style="color:red;display:none;"><b>Email is required</b></span> <span id="email_invalid" style="color:red;display:none;"><b>Email is invalid</b></span> <span id="email_taken" style="color:red;display:none;font-size:14px;margin-top:10px;"><b><?php echo $emailTaken;?></b></span> <span style="color:red;display:none;font-size:14px;margin-top:10px;" id="remail1"><?php echo $enteremail;?></span> <span style="color:red;display:none;font-size:14px;margin-top:10px;" id="vremail1"><?php echo $entervalidemail;?></span> </div>
        <div class="sf_input sf_input_pass" id="passred">
          ...
          <span style="color:red;display:none;font-size:14px;margin-top:40px;" id="pass1"><?php echo $enterpass;?></span> <span style="color:red;display:none;font-size:14px;margin-top:40px;" id="passlong"><?php echo $sixmin;?></span> </div>
        <div class="sf_input sf_input_pass" id="cpassred">
          ...
          <span style="color:red;display:none;font-size:14px;margin-top:42px;" id="cpassconf"><?php echo $confpass;?></span> <span style="color:red;display:none;font-size:14px;margin-top:42px;" id="cpassconf1"><?php echo $passmissmatch;?></span> </div>
...
<div class="header">
  <div class="wrapper clearfix">
    <div class="hdr-wdt"> <a href="<?php echo base_url();?>"><img src="<?php echo Base_url("images/main/logo-big.gif");?>" alt="TheTalkList" title="TheTalkList" class="logo"></a>
      <div class="top_navi">
        <div class="navi_col top_link_hover">
		
          <ul id="top_navi" class="tpNav1">
            <li><a href="<?php echo Base_url("students/index");?>" class="top_link students">
              <!--Students-->
              <?php
			$arrVal 	= $this->lookup_model->getValue('1236', $multi_lang);		$BE_A   		= $arrVal[$multi_lang];
			?>
              <?php echo $BE_A; ?><span><?php echo $stu;?></span></a>
              <?php /*<ul>
                <li><a href="<?php echo Base_url("students/index#select_tutor");?>">
                  <!--Selecting a Tutor-->
                  <?php echo $lSELECTING_TUTOR;?></a></li>
                <li><a href="<?php echo Base_url("students/index#buying_credit");?>">
                  <!--Buying Credits-->
                  <?php echo $lBUYING_CREDITS;?></a></li>
                <li><a href="<?php echo Base_url("students/index#guarantee");?>">
                  <!--Guarantee-->
                  <?php echo $lGUARANTEE?></a></li>
                <li><a href="<?php echo Base_url("search/search");?>">
                  <!--Tutor Search-->
                  <?php echo $lsearch;?></a></li>
        ...
        <div class="navi_col">
          <ul id="top_navi" class="tpNav2">
            <li><a href="<?php echo Base_url("tutor/index");?>" class="top_link tutors">
              <!--Tutors-->
              <?php //echo $lTutors;?>
              <?php echo $BE_A; ?><span><?php echo $tutor;?></span></a>
              <?php /*<ul>
                <li><a href="<?php echo Base_url("tutor/index#overview");?>">
                  <!--Overview-->
                  <?php echo $lOVERVIEW;?></a></li>
                <li><a href="<?php echo Base_url("tutor/index#become_trust");?>">
                  <!--Become a Tutor-->
                  <?php echo $lBECOME_TUTOR;?></a></li>
                <li><a href="<?php echo Base_url("tutor/index#levels");?>">
                  <!--Levels-->
                  <?php echo $lLEVELS;?></a></li>
                <li><a href="<?php echo Base_url("tutor/index#make_money");?>">
                  <!--Make Money-->
                  <?php echo $lMAKE_MONEY;?></a></li>
                <li><a href="<?php echo Base_url("tutor/index#market_yourself");?>">
                  <!--Market Yourself-->
                  <?php echo $lMARKET_YOURSELF;?></a></li>
                <li><a href="<?php echo Base_url("support/faqs");?>"><?php echo $lFAQ;?></a></li>
              </ul>*/?>
            </li>
          </ul>
        ...
        <?php /*<div class="navi_col">
          <ul id="top_navi" class="tpNav3">
            <li><a href="<?php echo Base_url("school/index");?>" class="top_link school"><span><?php echo $schoolProgram; ?></span></a>
              <ul>
                <li><a href="<?php echo Base_url("school/index#soverview");?>" onClick="showContent('soverview'); return false">
                  <!--Overview-->
                  <?php echo $lOVERVIEW;?></a></li>
        ...
        <div class="navi_col signinbtn">
          ...
          <?php endif;?>
          <ul id="top_navi" class="tpNav3">
            <li><a style="margin-left:30px;color:#3399CC;"  class="viewsite">
              <?php //echo $viewsite;?>
              <?php echo $cnglang ?>></a>
        ...
        <div class="navi_col signinbtn">
          ...
          <div class="welcome_sec">
            ...
            <a href="<?php echo Base_url("user/Affiliate");?>"><?php echo $lwelcome; ?>, <?php echo ucfirst($this->session->userdata['welcomeuser']);?> </a><em><br>
            </em> <a id="xOutUser" href="<?php echo Base_url("user/slogout");?>"><?php echo $llogout?></a>
            <?php }else {?>
            <a href="<?php echo Base_url("user/dashboard");?>"><?php echo $lwelcome; ?>, <?php echo ucfirst($this->session->userdata['welcomeuser']);?> </a><em><br>
            </em> <a id="xOutUser" href="<?php echo Base_url("user/slogout");?>"><?php echo $llogout?></a>
            <?php }?>
          </div>
          <ul id="top_navi" class="tpNav3">
            <li><a style="margin-left:20px;color:#3399CC;margin-top:-21px;"  class="viewsite">
              <?php //echo $viewsite;?>
              <?php echo $cnglang ?>></a>
              <ul style="font-size:1em; position:absolute; background:#666; width:100%; left:0; top:21px; display:none;">
                <li><a onClick="changeLanguage('en');" class="multi_lang_change">English</a></li>
...
<div class="footer">
  <div class="wrapper clearfix">
    <div class="speak_like_native">
      <!--Speak English Like a Native-->
      <?php echo $lSPEAK_EN_LIKE_NATIVE;?></div>
    <div class="socialize"> <span>
      <!--Connect with us-->
      <?php echo $lCONNNECT_WITH_US;?> :</span>
      <?php if($multi_lang == 'ch') { ?>
      <!--Chinese Social Icons-->
      <a href="https://weibo.com/3847933545/profile?rightmod=1&wvr=5&mod=personinfo" target="_blank" ><img src="<?php echo Base_url("images/sina.png");?>" width="32" height="32" alt="social1" /></a> <a href="https://user.qzone.qq.com/2977798206" target="_blank" ><img src="<?php echo Base_url("images/qq.png");?>" width="32" height="32" alt="social1" /></a>
      <!--Chinese Social Icons-->
      <?php } ?>
      <a href="https://www.linkedin.com/company/3126401?trk=tyah" class="ln" target="_blank" ></a> <a href="https://www.facebook.com/TheTalkList" class="fb" target="_blank" ></a> <a href="https://twitter.com/thetalklist" class="tw" target="_blank" ></a> 
	  <!--<a href="https://plus.google.com/117271187089694253468/posts" class="gp" target="_blank" ></a>-->
	  <a href="https://www.youtube.com/user/TheTalkList" class="yt" target="_blank" ></a> <a href="<?php echo base_url('blog'); ?>" class="blog" target="_blank" ></a> </div>
    <div class="footer_links"> <span>
      <!--Copyright-->
      <?php echo $lcopyright;?> 2013 &copy; TheTalkList. &nbsp; &nbsp; <?php echo $lallrightreserve;?>
      <!--All Rights Reserved-->
      </span> <a href="<?php echo Base_Url('article/privacy');?>">
      <!--Privacy Policy-->
      <?php echo $lprivacy_policy;?></a> <a href="<?php echo Base_Url('article/terms');?>">
      <!--Terms of Use-->
      <?php echo $lterms;?></a> <a href="<?php echo Base_Url('article/contact');?>">
      <!--Contact Us-->
      <?php echo $lcontact;?></a> <a href="<?php echo Base_Url('article/about');?>">
      <!--About Us-->
      <?php echo $labout;?></a> <a href="<?php echo Base_Url('affiliate/index');?>">
      <!--About Us-->
      <?php echo $affiliate;?></a> <a href="<?php echo Base_Url('article/site_map');?>">
      <!--Site Map-->
      <?php echo $lSITE_MAP;?></a> </div>
  </div>
</div>
<!--FOOTER END -->
<?php /*?>
...
<div id="booknowPopup" style="display:none;" class="ui-dialog ui-widget ui-widget-content ui-corner-all">
  ...
  <div class="sr-pop-cnt"> Do you want to still be available NOW? <br/>
...
<div style="border: 1px solid #AAAAAA;margin: 0 36%;position: absolute;top: 300px;width: 400px;z-index: 9999999;background:#fff;" class="ui-dialog ui-widget ui-widget-content ui-corner-all">
  ...
  <div style="padding: 10px;"> This web site needs javascript activated to work properly. Please activate it. Thanks! </div>
</div>
</noscript>
<script>
$(function(){

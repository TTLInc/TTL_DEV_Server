<?php $this->layout->setLayoutData('content_for_layout_title','Add lang');?>
...
<form method="post" action="" name="articleform" id="articleform" enctype="multipart/form-data">
    ...
    <p class="setft"> <input type="text" name="lang" id="lang" value=""  class="adm_box1" /></p>
...
setTimeout('showmenu("psettings",1)',1000);
</script>
</body>
</html>
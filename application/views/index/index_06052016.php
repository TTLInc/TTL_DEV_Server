...
switch ($visitorstatus) {
	case "registered":
			if($multi_lang == 'es'){
				...
				$homeImgSrc = base_url("images/returning_registered.jpg");
			}
	...
	default:
			if($multi_lang == 'es' || $multi_lang == 'pt'){
				...
				$homeImgSrc = base_url("images/home_banner.jpg");
			}
	...
	<div class="container">
        <div class="banner_content_main" style="right:0;left:inherit;">
            ...
            <h2 style="color:#000000;">
				<?php
				$arrVal = $this->lookup_model->getValue($getValueOfConv, $multi_lang);
				$lngConversion= $arrVal[$multi_lang];
				echo $lngConversion;
				?>
			</h2>
...
<div class="es-banner-main-mobile">	
<?php }else{ ?>
	...
	<div class="container cf">
        ...
        <div class="video_main videomain2">
            <?php
                ...
                {?>
                <video style="cursor:pointer;background-color:#FFF;" id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" width="100%" height="219" controls preload="auto"  poster="<?php echo base_url("uploads/video/dashboardvideo2.png");?>" data-setup="{}">				
					<?php if($multi_lang == 'es'){ ?>
						<source src="<?php echo base_url("uploads/video/ttl-experience_EScaptions_v5.mp4");?>" type='video/mp4'/>
					<?php }else{ ?>
						<source src="<?php echo base_url("uploads/video/ttl-experience_v3.mp4");?>" type='video/mp4'/>
					<?php } ?>
              </video> 
              <?php }?>
        </div>

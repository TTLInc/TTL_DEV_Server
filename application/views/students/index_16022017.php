<link rel="canonical" href="https://www.thetalklist.com/en/students/" />
...
$arrVal 	= $this->lookup_model->getValue('1177', $multi_lang);	$lngTutFree  	= $arrVal[$multi_lang];
$arrVal 	= $this->lookup_model->getValue('1178', $multi_lang);	$lngTutFreeSub 	= $arrVal[$multi_lang];
/* End */
?>
...
<!--SIGNUP FORM START -->
    ...
    <div class="page_title wht-ttl">
    	<div class="wrapper for-staticpg"><div class='stuh1class'><!--Student Details--><?php echo $lSTUDENT_DETAILS?></div></div>
    </div>
    <!--PAGE TITLE END -->
    	...
    	<div class="wrapperinner">
            ...
            <div class="selecting_tutor_table clearfix">
                ...
                <div class="st_row clearfix">
                    ...
                    <div class="brows-twt"><div id="text4" class="brw-ttl"><p><?php echo $readyto?><br><?php echo $findtutor;?></p></div><a href="<?php echo Base_url("search/search");?>"><span class="brw-tutr1"><?php echo $browsetutor;?></span></a><img class="himg" src="<?php echo base_url('images/students-pg-img.png')?>"></div>
                </div>
				...
				<p><?php echo $stutorbase;?></p><br>
								...
								<div class='stupage'><h1>Find Language Tutors Online</h1></div>
            ...
            <div class="buying_credits byd-cdt-sm">
                ...
                <p><!--Prices of tutors and videos vary, but here is the type of value a student gets.--><?php //echo $lBUYING_CREDITS_DESC2;?><?php echo $lngTutFree;?><br><?php echo $lngTutFreeSub;?></p>
                </div>
                
                
                <div class="buying_credits_new clearfix">
                    <div class="bc_col_1"><?php echo $lVIRTUAL_CREDITS;?></div>
                    <div class="bc_col_2"></div>
                    <div class="bc_col_3">
                        <span><?php echo $lessionseven;?></span>
                        <div class="bc_icon"></div>
                        <span>(<?php echo $mineach; ?>)</span>
                    </div>
                    <div class="bc_col_4"></div>
                    <div class="bc_col_5">
                        <span><?php echo $fiverecorded;?></span>
                        <div class="bc_icon"></div>
                        <span>(<?php echo $creativetopic;?>)</span>
                    </div>
                    <div class="bc_col_6">
                        <a href="<?php echo Base_url("user/signup"); ?>" class="sign-btn-stn"><?php echo $lsign_up;?> >></a>
                    </div>
                  </div>
      
      
                <div class="buying_credit_table" style="display:none;">

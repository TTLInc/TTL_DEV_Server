								...
								<tbody id="nbmesg">
									...
									<tr class="read<?php echo $message['isRead'];?> " inboxId="<?php echo $message['id'];?>">
										...
										<td>
											...
											TalkMaster BlueBob
											<?php else:?>
											<p <?php if($message['isRead']) { echo "style='color:#000000;'"; } else{ echo "style='color:#000000;font-weight:bold;'"; } ?>><?php echo $message['username'];?></p>

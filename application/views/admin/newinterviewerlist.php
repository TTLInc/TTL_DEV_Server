...
<table class="data_table">
	...
	foreach ($users as $key => $val) :?>
        <tr id="id_<?php echo $val['uid'];?>">
			...
			<td class="rw10"><div class="rw10">
            <a href="<?php echo base_url('admin/EditNewInterviewer/id/'.$val['newtutorid']);?>"><img alt="Edit" src="<?php echo base_url('/images/cm_pencil.png');?>" /></a>
...
function del(_id){
	if(window.confirm('Are you sure you want to delete this?')){
		$.post('<?echo base_url("admin/DelteNewinterviewer")?>',{id:_id},function(msg){

...
<div class="baseBox baseBoxBg clearfix">
	...
	<div class="content_main fr">
        ...
        <div id="student_prof_Wp">
            <div class="mod">
				<div class="content tle"><h2><?php echo "Activity";?></h2></div>
				<div class="bd">
					<?php if(count($affiliate) > 0){ ?>
					<div style="float:right;margin-top:-22px;">
						<span style="font-size:18px;">Monthly Statement&nbsp;&nbsp;</span>
					...
					<table class="history_table f14" id="ttest">
					 ...
					 <span class="due" style="float:left;font-size:2.2em;font-weight:300;">Commissions Due: $<?php if($affiliate[0]['paid']==1) echo "0.00";else echo number_format($cmn,2,'.','');?></span>
					   <span class="due" style="float:right;font-size:2.2em;font-weight:300;">Total Commissions: $<?php echo number_format($cmn,2,'.','');?></span>
				<?php }else {?>
        ...
        <div id="student_prof_Wp">
					...
					<a style="float:left;" class="adbtn" href="<?php echo base_url('user/tsearch') ?>"><?php echo $addnew;?></a>
					 ...
					 <table class="history_table f14" id="ttest">
						 ...
						 <tr>
						   ...
						   <span style="font-size:15px;"><?php echo $Sessions;?> <?php if($tutorforaccount[0]['total1']!='')echo $tutorforaccount[0]['total1'];else echo '0' ?> </span>	
						   <span style="font-size:15px;margin-left:25px;"><?php echo $tarning;?> <?php echo "$".  $a=number_format(($tutorforaccount[0]['totalfee1']-$tutorforaccount[0]['total1']*$sch),2,'.','');?></span>	
						   <span style="font-size:15px;margin-left:25px;"><?php echo $stutorearning;?><?php echo "$".$b=number_format(($tutorforaccount[0]['total1']*$sch),2,'.','');?> </span>
						  <span style="font-size:15px;margin-left:25px;"><?php echo $sstudenteraning;?><?php if(count($samout)>0){echo "$"."".number_format($samout[0]['earning'],2,'.','');};?></span>	
                ...
                <!--raxa 03-08-13 start-->
                 ...
                 <div class="mod">
						...
						<div class="content tle"><h2><?php echo $students1;?></h2></div>

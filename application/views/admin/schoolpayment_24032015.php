        ...
        <tr id="id_<?php echo $val['id'];?>">
           <!-- <td><input type="checkbox" name="ids[]" value="<?php echo $val['id'];?>" /></td>-->
			...
			<td id="actions" class="<?php echo $class; ?>" >
				...
				<?php } ?>
				<?php if($val['dues'] > 0){?>
				<a href="javascript:void(0);" class="appcat" mid="<?php echo $val['School_id']; ?>" val="<?php echo $val['dues']; ?>" title="Approve"><img alt="Approve" src="<?php echo base_url('/images/approve-red.png');?>" /></a>
				<?php } else {?>

...
$(document).ready(function() {
	$( ".fc-sun" ).on('click',function() {
	  ...
	  var booking_amt = $('#hdnschooltutorcost').val();
	  $('#bookingamount').val(booking_amt);
                         ...
                         <div class="content tle rating">
							  ...
							  <div class="cl-bking">
                              	<span class="bking-tooltip">
									...
									?>
                                	<a class="bkclass" style="cursor:pointer;" onClick="bookNow(<?php echo $current_uri4 ;?>);"><img src="<?php echo site_url('images/pop-img-hst.png')?>"/></a>
									...
									<?php } else {?>
									<img src="<?php echo site_url('images/gary-video-icon.png')?>" />
									
									<?php }?>
                                </span>
                              </div>
                              <div class="cl-tmlot" id="bookTip" style='cursor:pointer' onclick='checkBookTip()'>
                              	<span class="tmlot-tooltip"><a><?php echo $Books;?></a>
								<div class="tmlot-tooltip-cnt">
								<?php

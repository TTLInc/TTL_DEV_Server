...
<!--SIGNUP FORM START -->
	            	...
	            	<div class="sf_select">
		            	<span class="select_box_holder sel_width_215">
		                    <select id="roleId" name="roleId" class="cu_dds">
		                        <option value="1"><?php echo $lIAMA;?></option><!--I am a...-->
    ...
    <div class="page_title">
    	<div class="wrapper"><h1><!--Tutor Details--><?php echo "Affiliate Details";?></h1></div>
    </div>
    <!--PAGE TITLE END -->
    ...
    <div class="content">
    	<div class="wrapperinner">
            ...
            <p>TheTalkList affiliates expand the reach of the site to other students who want to speak like a native.  TTL affiliates have the opportunity to make money promoting the site and receive advertising material support.
            	<?php // echo $lOVERVIEW_DESC;?>
            </p>
            <div style="padding:40px 0px 40px 0px; text-align:center;">
            <img style="margin:0px 80px 0px 0px;" src="http://dev.thetalklist.com/images/main/affiliate-img01.jpg" width="157" height="157">
          <img style="margin:0px 80px 0px 0px;" src="http://dev.thetalklist.com/images/main/affiliate-img02.jpg" width="193" height="161">
          <img src="http://dev.thetalklist.com/images/main/affiliate-img03.jpg" width="157" height="157">
          </div>

            
                        
          <h2 id="become_trust"><!--Become a Tutor--><?php echo "Become an Affiliate"?></h2>
          ...
          <img src="http://dev.thetalklist.com/images/main/become-affiliate-img.jpg" width="227" height="184"></div>
            <p>As an international platform, TheTalklist is looking for affiliates in any country.  Our affiliates can take advantage of the tremendous market size and the lifetime buying cycle that language learners have.  We want to partner with you today!
            ...
            <div class="steps_inner clearfix" style="padding-top:0px;">
            	...
            	<div class="step step_1">
                	<div class="step_title"><!--Meet Requirements--><?php echo "Sign Up"?></div>
                    <ul>
                    	<li><!--High speed internet--><?php echo "Provide your info"?></li>
                    	<li><!--Webcam/Mic--><?php echo "Receive affiliate code"?></li>
                    </ul>
                </div>
                <div class="step step_2">
                	<div class="step_title"><!--Take e-Training--><?php echo "Deploy Advertisements"?></div>
                    <ul>
                    	<li><!--Learn conversation tutoring--><?php echo " Use existing ad"?></li>
                        <li><!--Learn to use our platform--><?php echo "Request custom ad"?></li>
                        <li><!--Learn to use our platform--><?php echo "Post ads"?></li>
                    </ul>
                </div>
                <div class="step step_3">
                	<div class="step_title"><!--Enjoy TheTalkList<br>Experience--><?php echo "Monitor your Income"?></div>
                    <ul>
                    	<li><!--Develop a global reach--><?php echo " View qualifying transactions"?></li>
                    	<li><!--Start making money--><?php echo "Receive monthly payments to PayPal"?></li>
                    </ul>
                </div>
            ...
            <div class="steps_inner tenpercentimg clearfix">
            	...
            	<div class="step step_1 step-width" >
                	<div class="step_title step-gray">Student clicks your affiliate link</div>
                    
                </div>
                <div class="step step_2 step-width" >
                	<div class="step_title step-gray">Affiliate is credited for first account purchase.</div>
                    
                </div>
                <div class="step step_3 step-width">
                	<div class="step_title step-gray">After first paid session, affiliate is paid 10% ($2.50-$50.00).</div>

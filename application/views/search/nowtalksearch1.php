...
var _nasa={};
 _nasa["cnv"] = wcs.cnv("2","10"); // ÀüÈ¯À¯Çü, ÀüÈ¯°¡Ä¡ ¼³Á¤ÇØ¾ßÇÔ. ¼³Ä¡¸Å´º¾ó Âü°í
</script>
<?php 
    ...
    <div class="search_mid">
		<div class="search_lf">
			<div class="search_lf_top">
				<span class="left-ttl"><?php echo $lbuildatutor;echo $sessionSearchData['readytotalknowSelected'];?></span>
			</div>
				...
				<dl>
					...
					<dd>
						<span class="nobg check">
							...
							<input id="anytutor" name="anytutor" value="1" <?php if(@$sessionSearchData["anytutorSelected"] == 'true'){echo "checked='checked'";}  ?>  type="radio" onMouseDown="this.__chk = this.checked" >
					...
					<dd>
						...
						<!--<input id="online" name="online" value="1" <?php if(@$sessionSearchData["onlineSelected"] == 'true'){echo "checked='checked'";} ?>  type="radio" onMouseDown="this.__chk = this.checked" onClick="if (this.__chk) this.checked = false">-->
							<input id="readytotalknow" name="readytotalknow" value="1" <?php if(@$sessionSearchData["readytotalknowSelected"] == 'true'){echo "checked='checked'";} echo $defaultAny;?>  type="radio" onMouseDown="this.__chk = this.checked">
        ...
        <div class="src-hd" style="margin-bottom:30px;">
			...
			<input type="button" id="deactivateMap" class="blu-btn" value="<?php echo $lDE_ACTIVATE_MAP;?>" style="cursor:pointer;margin-left: 632px;margin-top: -30px;position: absolute;width: 112px;display:none;">
			<div class="search_rt_top" id="map_canvas" style="height:500px;"></div>
			<!--R&D@Nov-29-2013 : Set Static Map-->
			<div class="search_rt_top" id="static_map_canvas" style="height:500px"><img id="static_map_canvas_image" src="<?php echo base_url("images");?>/tutors/tutor_search_activate.png"></div>			
			<!--R&D@Nov-29-2013 : Set Static Map-->
...
<dd>
	<div class="dd_top">
		...
		<div class="dd_rt">
			...
			{($T.hRate > 0) ? $T.hRate : '0.00'} <?php echo $lcredits; ?>/<?php echo $vsession;?>
            </div>
	...
	<div class="dd_bot">
		...
		<a class="btn_red_big_session crapp" href="{createClassUrl($T.uid)}" title="<?php echo $lFREE_SESSION;?>"><?php echo $lFREE_SESSION;?></a>
		<?php endif; ?>
	   <?php //}?>
        </div>
		
		<div class="tonline" style="{($T.online == 1) ? 'display:block;' : 'display:none'}" ><img src="<?php echo Base_url('images/active-login.png'); ?>" alt="online" />Logged In</div>
		...
		function getCookieValue(key)
		{
			...
			function loadmarker(data)
			{
				...
				}else
				{
					...
					var iconBase = 'http://techno-sanjay/dev.thetalklist.com/images/';
					var marker = new google.maps.Marker({
									map: map,
									position: ab,
									title: data.username,

 ...
 <div class="baseBox baseBoxBg clearfix">
        ...
        <div class="content_main fr">
        	<div class="main_inner">
                <?php //echo Affiliate_menu($linkType,'c_prof');?>
                <!--/student_prof-->
                    ...
                    <div class="mod">
                        <div class="hd">
                            ...
                            <div class="pro-settg">
                            	<div class="tab-nav">
                                	<ul>
                                    	<li onClick="showHide('con1');" class="<?php if($currentTab == "col1"){ echo 'active';}?>"><?php echo "Affiliate";?></li>
...
<form name="cancelInfoFrm" id="cancelInfoFrm" action="<?php echo Base_url('user/AffiliateInfo');?>" method="POST">
</form>								
                                	<div class="sub-cnt" id="con1" style="display:<?php if($currentTab == "col1"){ echo 'block';}else{ echo 'none';}?>;">
									<form action="<?php echo Base_url('user/AffiliateInfo');?>" method="POST" onsubmit="return validateFormCon1();">
                                    	<div class="cnt-rw">
                                        	<label><?php echo "Affiliate Name";?>:</label>
                                            <input autocomplete="off"  name="name" id="name" type="text" value="<?php echo $profile['firstName'];?> <?php echo $profile['lastName'];?>" maxlength="20"/>
                                        </div>
                                        
                                        <div class="cnt-rw">
                                        	<label><?php echo "Principle Name";?>:</label>
                                            <input name="principle_name" type="text" value="<?php echo $profile['principle_name'];?>" maxlength="20"/>
                                        </div>
										
										
                                        <div class="cnt-rw">
                                        	<label><?php echo "Address";?>:</label>
                                            <input name="address" type="text" value="<?php echo $profile['address'];?>" maxlength="40"/>
                                        </div>
										<div class="cnt-rw">
									...
									<form action="<?php echo Base_url('user/AffiliateInfo');?>" method="POST"  onsubmit="return validateFormCon3();">
                                    	<div class="cnt-rw">
									...
									<form action="<?php echo Base_url('user/AffiliateInfo');?>" method="POST"  onsubmit="return validateFormCon3();">
										...
										<div class="cnt-rw">
                                        	<label><?php echo "Payment Account";?>:</label>
                                            <input autocomplete="off"   type="text" value="<?php echo $profile['payment_account'];?>" id="payment_account" name="payment_account"/> 
                                        </div>
                                        <div class="cnt-rw">
                                        	<label><?php echo "Affiliate Link";?>:</label>
                                            <input autocomplete="off" disabled  name="a_link" type="text" value="<?php echo $encode;?>"/> 
                                        </div>
                                   ...
                                   <div class="sub-cnt" id="con6" style="display:<?php if($currentTab == "col6"){ echo 'block';}else{ echo 'none';}?>;">
										<form action="<?php echo Base_url('user/AffiliateInfo');?>" method="POST" onsubmit="return validateFormCon2();">
										<div class="cnt-rw">

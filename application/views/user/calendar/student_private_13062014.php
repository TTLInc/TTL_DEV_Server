 ...
 <div class="baseBox baseBoxBg clearfix">
        <div class="content_main fr">
			...
			<?php if($uri ==''){?>
                	<div class="mod">
                        <div class="hd">
                            <div class="pro_tle tle"><h3><span class="ltimez"><?php echo $lcalender;?> (<?php echo $lLOCAL_TIMEZONE;?>)</span></h3></div>
                        </div>
						<!--<div class="bd">
		...
		*/
		...
		$('.delClass').click(function(){
            if(window.confirm('<?php echo $lDELETE_SESSION_MSG;?>')){
                ...
                var _delObj = $(this);
                $.getJSON('<?php echo base_url('user/delClass');?>',{id:_id},function(msg){
                   //alert(msg)
				   /*
					if (String == msg.constructor) {
                        eval ('var json = ' + msg);

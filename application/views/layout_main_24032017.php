...
<?php
if($_SERVER['HTTP_CLOUDFRONT_FORWARDED_PROTO'] == 'http'){ 
//echo "<pre>";
$request = $_SERVER['REQUEST_URI'];
//$url = str_replace('/georgetown/', '/' . $replace . '/', $url);

header("Location: https://www.thetalklist.com".$request);
}

if($_SERVER['REQUEST_URI'] == '/tutors'){
	header("Location: https://www.thetalklist.com/en/user/login");
}

if($this->uri->segments[0] == ''){
	header("Location: https://www.thetalklist.com/en".$_SERVER['REQUEST_URI']);
}
...
if($this->uri->segments[0] != 'en'){
	...
	header("Location: https://www.thetalklist.com/en".$request);
}
*/
$multi_lang = 'en';
...
$arrVal 	= $this->lookup_model->getValue('1389', $multi_lang);	$metaTitle = $arrVal[$multi_lang];
$arrVal 	= $this->lookup_model->getValue('1390', $multi_lang);	$metaDesc1 = $arrVal[$multi_lang];
$arrVal 	= $this->lookup_model->getValue('1391', $multi_lang);	$metaDesc2 = $arrVal[$multi_lang];
?>
<title><?php echo "Talk-ist ".$profile['firstName'].", TheTalkList";?></title>
<!--<title><?php echo $profile['firstName']." is teaching me on TheTalkList.com";?></title>
<meta property="og:title" content="<?php echo $profile['firstName']." is teaching me on TheTalkList.com";?>">-->
<meta property="og:title" content="<?php echo $metaTitle;?>">
<meta property="og:site_name" content="The TalkList">
<meta property="og:url" content="<?php echo current_url();?>">
<meta property="og:description" content="<?php echo ucfirst($profile['firstName'])." ".$metaDesc1."&nbsp;&nbsp;".(($profile['gender']=="0") ? "She's " : "He's ").$metaDesc2;?>">
<meta property="fb:app_id" content="564390540302547">
<meta property="og:type" content="profile">
<meta property="og:image" content="<?php echo base_url().'timthumb.php?src=/uploads/images/thumb/'.$profile['pic'].'&w=200&h=200';?>" />
...
<link id="bico" type="image/x-icon" href="https://www.thetalklist.com/images/talklist.ico" rel="bookmark">
<link id="bsico" type="image/x-icon" href="https://www.thetalklist.com/images/talklist.ico" rel="shortcut icon">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('css/popup-css.css');?>">
<!--CSS END -->
...
$(document).ready(function(){
	$("#dialog").html('<h2 class="txtblue martoppl10"><?php $this->session->unset_userdata('registermsg');	echo $lngregSucMsg;?></h2><a href="#" class="go-btn">Go</a>');
...
<!--<script src="https://www.thetalklist.com/js/home/jquery-1.8.2.js" type="text/javascript"></script> -->
...
<body onLoad="wireUpEvents()" class="inner-pg-bd"><?php include_once FCPATH."idle/idle.php";?>

<!-- riveted js -->

<script src="<?php echo base_url('js/riveted.min.js');?>"></script>
...
<?php
            ...
            <div class="sf_padding">
	            ...
	            <form style="display:block;" action="<?php echo Base_url('user/registerDo');?>" method="POST" id="registerForm123">
	            	<div class="sf_select" id="mroll">
                        ...
                        <span style="color:red;display:none;font-size:14px;margin-top:33px;" id="rid2"><?php echo $selectuser; ?></span>-->
					</div>
		            ...
		            <div class="sf_input sf_input_pass" id="mainpass">
		                ...
		                <span style="color:red;display:none;font-size:14px;margin-top:40px;" id="mpass1"><?php echo $enterpass;?></span> 
						<span style="color:red;display:none;font-size:14px;margin-top:42px;" id="passlongs"><?php echo $sixmin;?></span>
					</div>
		            <div class="sf_input sf_input_pass" id="mainpassc">
		                ...
		                <input autocomplete="off" id="cpassword2" name="cpassword " type="password" size="25" class="txtbox iposition" id="confirm_password2" style="display:none;">
		                 <span style="color:red;display:none;font-size:14px;margin-top:32px;" id="cpass2"><?php echo $confpass;?></span>
						 <span style="color:red;display:none;font-size:14px;margin-top:42px;" id="fcpass2"><?php echo $passmissmatch;?></span>
				   </div>
 ...
 <?php }?> 
   ...
   $current_uri4 = $this->uri->segment(4);
    ...
    <?php }
	if($this->uri->segments[2] == 'videosearchmore'){
		
	}else{
	if($this->uri->segment(2) !='testVeeSession') {?>
<div class="header">
	<div class="wrapper clearfix">
		...
		?>
			...
			?>
			 ...
			 {?>
			<div class="navi_col navi_col2 top_link_hover"><ul id="top_navi">
			 ...
			 <?php }?>
				<div class="navi_col navi_col2"><ul id="top_navi"><li class="<?php echo in_array($actClass,array("search")) ? "active" : "";?>"><a class="top_link2 tutors-search" href="<?php echo Base_url("search/search");?>"> <?php echo $search;?></a></li></ul></div>
				<div class="navi_col navi_col2"><ul id="top_navi"><li class="<?php echo ($actClass=="videosearch") ? "active" : "";?>"><a class="top_link2 video-search" href="<?php echo Base_url("search/videosearch");?>"><?php echo $videotext;?></a></li></ul></div>
		
				<div class="navi_col navi_col2">
					<ul id="top_navi" class="tpNav1">
						<li class="<?php echo (in_array($actClass,array("faqs","resources")) or ($this->uri->segment(1)=="forum")) ? "active" : "";?>"><a class="top_link2 support" href="#"><?php echo $lSUPPORT;?></a>
            ...
            <div class="top_navi">
				<?php 
				// Contests Condition Start
				if ($this->uri->segment(1)!="contests") {?>
            	<div class="navi_col top_link_hover">
                	<ul id="top_navi" class="tpNav2">
	                	<li class="<?php echo ($current_uri1=="students") ? "active" : "";?>"><a href="<?php echo Base_url("students/index");?>" class="top_link students"><!--Students--><?php echo $BE_A; ?><span><?php echo $stu;?></span></a>
                        	<ul>
            	...
            	<div class="navi_col">
                	<ul id="top_navi" class="tpNav3">
	                	  <li class="<?php echo ($current_uri1=="tutor") ? "active" : "";?>"><a href="<?php echo Base_url("tutor/index");?>" class="top_link tutors"><!--Tutors--><?php //echo $lTutors;?><?php echo $BE_A; ?><span><?php echo $tutor;?></span></a>
                        	<ul>
			...
			<div class="navi_col">
                	<ul id="top_navi" class="tpNav3">
	                	<li class="<?php echo ($current_uri1=="school") ? "active" : "";?>"><a href="<?php echo Base_url("school/index");?>" class="top_link school"><span><?php echo $schoolProgram;?></span></a>
                        	<ul>
   ...
   ?>
	...
	if($this->uri->segments[2] == 'videosearchmore'){
		...
		if($this->uri->segment(2) !='testVeeSession') {
		 $cls = "";
		 if(in_array($lagin,array('privacy','terms','contact','about','site_map')))
		 {
			 $cls =  "for-staticpg";
		 }		
		?>
    <div class="page_title">
	   ...
	   <?php if($uid_readytalk[0]['readytotalk']==1 AND $tutorfreesession == 'y'){?>
...
<div class="wrap wrap-login" style="margin-top:222px;" >	
    <?php }else{?>
	<div <?php if($this->uri->segments[2] != 'videosearchmore'){ ?> class="wrap" <?php } ?> style="margin-top:0px;" >
	<?php }?>
...
<div class="footer">
	<div class="wrapper clearfix">
		...
		<div class="socialize">
			...
			<a href="https://weibo.com/5629851993/profile?topnav=1&wvr=6" class="sina"></a>
			<!--<a href="https://user.qzone.qq.com/2977798206"><img src="<?php echo Base_url("images/qq.png");?>" width="40" height="40" alt="social1" /></a>-->
			<?php } ?>
			<!--R&D@Oct-19-2013 : Chinese Social Icons-->
		...
		<div class="footer_links">
			...
			<a href="https://www.thetalklist.com/sitemap.xml"><?php echo $site;?></a> 
		</div> 
	</div>
</div>
...
var _getStatusClassConfirm = setInterval(getStatusClassConfirm,10000);
...
function jsonpCallback(data){ 
 location.reload();
 //window.location.href = 'https://www.thetalklist.com';
}*/
...
var currentDomain = $('#xOutUser').attr('href');
if(currentDomain == '<?php echo base_url("user/logout");?>'){
...
$current_talk_user_id	=	0;
$is_talk_dashboard			=	true;
if(isset($self_url)){
	$self_url_array = explode('/', $self_url);
	if(isset($self_url_array)){
		foreach($self_url_array as $key=>$value){
			if(isset($value)){
				if($value > 0){
					$current_talk_user_id = $value; 
				}
				if($value == 'uid'){
					$is_talk_dashboard  = false;
				}
			}
		}
	}
}
if($current_talk_user_id == 0 && $is_talk_dashboard == true){
...
$(document).ready(function() {
	function checktalknowlight(){
		if ( $( "#readytotalk" ).length ) {
			var talknow_request_chk;
			
			talknow_request_chk = $.ajax({
				url: '<?php echo base_url("user/checktalknowlight");?>',
				type: "post",
				data: {'uid' : '<?php echo $current_talk_user_id;?>'}
			});
			talknow_request_chk.done(function (response){
				if(response == 'no'){
					$('.defaultP').html('');
					$('.defaultP').html('<input type="checkbox" name="readytotalk" id="readytotalk" value="0" style="display:none;"/>');
					$('.defaultP input').ezMark();
					$('#readytotalk').prop('checked', false).change();
	...
	setInterval(function(){ checktalknowlight(); }, 10000);
}); 
</script>
<?php //--------------------RD JULY 14-------------// ?>
...
<?php
if($_SERVER['REQUEST_URI'] == '/search/search' OR $_SERVER['REQUEST_URI'] == '/search/nowtalksearch'){
?>
<!-- begin olark code -->
...
olark.identify('9086-704-10-4711');/*]]>*/</script><noscript><a href="https://www.olark.com/site/9086-704-10-4711/contact" title="Contact us" target="_blank">Questions? Feedback?</a> powered by <a href="https://www.olark.com?welcome" title="Olark live chat software">Olark live chat software</a></noscript>
<!-- end olark code -->
...
<script type="text/javascript">
  ...
  (function() {
    ...
    t.async = true;
    t.id    = 'cio-tracker';
    t.setAttribute('data-site-id', 'a3b9defd81b6a11c9373');
...
<script type="text/javascript">
  _cio.identify({
    // Required attributes
    id: '<?php echo $this->session->userdata('uid');?>',           // Unique id for the currently signed in user in your application.
    email: '<?php echo $this->session->userdata['email'];?>', // Email of the currently signed in user.

...
$(document).ready(function(){
	...
	$('<audio id="chatAudio"><source src="<?php echo base_url('css/audioPlayer/Vee_session_tick.mp3');?>" type="audio/mpeg"></audio>').appendTo('body');
	$('<audio id="VeeSessionEndsound"><source src="<?php echo base_url('css/audioPlayer/VeeSessionEnd.wav');?>" type="audio/wav"></audio>').appendTo('body');
});
</script>
<script type="text/javascript">
$(function(){
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
	...
	function checkStatus(){
		...
		if(_startTime == -1440)
		{
			addMsg('The session has 60 secs remaining.');
			if(_startTime == -1490){
		...
		if(_startTime < -1500)
		{ 
			if (VeeSessionEndsound == 0) {				
				playVeeSessionEndsound();
				VeeSessionEndsound = 1;
			}
...
<div class="Room_wrap posR">
		...
		<span class="end"></span>
                ...
                <div class="Room_view f1">
                	<input type="hidden" value="" id="vuID" />
					 <div id="Room_player">
						<div  id="sRoom_player">
							<img src="<?php echo Base_url('images/gvs_room_video.jpg');?>" height="460px"/>
						</div>
	...
	<script>
		...
		<style>
			...
			.clearer{clear:both}
			.stars a.on {
				background: url('<?php echo base_url("images/star2.png");?>');
			}
			.stars a.off {
				background: url('<?php echo base_url("images/star2.png");?>') 0 -18px;
			}
			.stars a {
				width: 16px;
				height: 16px;
...
<div class="videosession_div"></div>
...
<script type="text/javascript">
$(document).ready(function(){
	$( "videosession_div" ).prependTo( "#subscriber_replace" );
	$("#categories option:first").attr("selected","selected");
	searchscenario();	
});
</script>
...
$('.col .day_'+ parseInt(v.month,10) + '_'+ parseInt(v.day,10) +' .event').html('<a href="javascript:void(0)" day="'+v.date+'"><input type="hidden" id="tst'+v.day+''+v.month+'" value="'+v.date+'"><span  class="'+_countClass+'">'+v.count+'</span> Sessions</a>');
					...
					if(_countClass == "count1"  || _countClass =="count3"){
						if(v.booked != 0){
							...
							if($("#"+bookingString).length != 0){ 
								...
								//$('.col .day_'+ parseInt(v.month,10) + '_'+ parseInt(v.day,10) +' .event').before('<h2 id="'+bookingString+'" style="background-color:#CCCCCC;color:red;width:5px;float:left;margin-top:30px;padding-left:5px;"><img src="http://thetalklist.com/images/orange-dot.png"></h2>');
								$('.col .day_'+ parseInt(v.month,10) + '_'+ parseInt(v.day,10) +' .event').before('<h2 id="'+bookingString+'" style="color:red;width:5px;float:left;margin-top:30px;padding-left:5px;"><img src="http://thetalklist.com/images/orange-dot.png"></h2>');
		...
		if($("#bNote").length != 0){
			...
			$('#calendar').after('<h3 id="bNote" style="color:black;"><img src="http://thetalklist.com/images/orange-dot.png"> = booking</h3>');
		}
	}
	return {

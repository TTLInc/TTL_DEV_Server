...
<form method="post" action="" name="articleform" id="articleform" >  
    ...
    <p class="setft">
   	...
   	<p class="ft_title">If prospective student has given us their email but has not registered, send weekly email reminder.</p>
    <p class="setft">
    	<textarea name="n3" id="n3" cols="80" rows="5"><?php echo @$newsletter['n3']; ?></textarea>
    </p>
	<p class="ft_title">If prospective student has registered and maybe taken a free session, but has not paid for their first session, send weekly email reminder.</p>
    <p class="setft">
	...
	<p class="ft_title">Free Session Expiration Alert</p>
    <p class="setft">
    ...
    <p class="setft">
    	<textarea name="n10" id="n9" cols="80" rows="5"><?php echo @$newsletter['n10']; ?></textarea>
    </p>
...
setTimeout('showmenu("adminmessages",0)',1000);
</script>
</body>
</html>
 ...
 */
    ...
    $fbconfig['appid' ]     = "1402541593364237";
    $fbconfig['secret']     = "c03b678468dd6ca158478b9c030a3efe";
    $fbconfig['baseurl']    = "http://dev.thetalklist.com/index"; //"http://thinkdiff.net/demo/newfbconnect1/php/sdk3/index.php";
    ...
    if ($user) {
	  ...
	  if($user_profile !='')
	  {
	       session_start();
			...
			//header("Location:http://dev.thetalklist.com/user/register.php");
	  }
    }

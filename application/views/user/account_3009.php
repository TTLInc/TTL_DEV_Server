...
$arrVal = $this->lookup_model->getValue('952', $multi_lang);
$loadaccount= $arrVal[$multi_lang];
				...
				<div class="bd">
					...
					<table class="history_table f14" id="ttest">
					 ...
					 <span class="due" style="float:left;font-size:2.2em;font-weight:300;">Commissions Due:$<?php if($affiliate[0]['paid']==1) echo "0.00";else echo number_format($cmn,2,'.','');?></span>
					   <span style="float:right;font-size:2.2em;font-weight:300;">Total Commissions: $<?php echo number_format($cmn,2,'.','');?></span>
				<?php }else {?>

...
<table class="data_table" border=0>
    ...
    ?>
	    ...
	    <!--<td><?php echo $val['id'];?></td>-->
			...
			$val_name = strip_tags($val['name']);
			if(strlen($val_name) > 100){
				$langvalue = substr($val_name,0,100)."...";
				} else {
				$langvalue = $val_name;
				}
				echo $langvalue;
		...
		-->
            ...
            <a href="javascript:void(0);" class="editmid"  id="editmid" editid="<?php echo $val['id']; ?>"><img alt="delete" src="<?php echo  base_url('images/cm_pencil.png')?>" /></a>
            </td>
        </tr>
        <?php } ?>
    </tbody>
...
$(function(){
	$(".submit-search").click(function() {
		...
		$form = $("<form id='frmlookup' method='post' action='<?php echo base_url('admin/multi_lang');?>'></form>");

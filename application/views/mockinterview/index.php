...
<div class="interviewpg main_banner">
    	<div class="wrapper">
            <div class="left-text">
                <h1><?php echo $lngWeHelp;?></h1>
                <h2><?php echo $through?></h2>
                <h2><?php echo $lngfirstfree;?></h2>
				<?php if(!$login):?>
                <div class="signup-btn">
                    <a href="<?php echo Base_url("user/register");?>" class="register_btn" id="register_btn"><?php echo $supnow;?></a>
                </div>
				<div class="cont-fb">
                    <a href="javascript:void(0);" class="fb_connect"><span><?php echo $cfacebook ;?></span></a>
                </div>
				<?php endif;?>
            </div>
            <div class="right-video-cnt" style="float:right;width:600px;">
                <div class="video-div" style="float:right;width:499px;">
                	<!--<img  src="<?php echo base_url("images/vee-ses-img.jpg");?>" alt="01"/>-->
					<ul class="bxslider">
					  <?php 
							for($i=0;$i<count($banners);$i++){
							?>
					  <li> <img src="<?php echo Base_url('uploads/images/thumb/'.$banners[$i]['source']);?>" alt="TheTalkList" title="TheTalkList"> </li>
					  <?php }?>
					</ul>
                </div>
            </div>
            ...
            <div class="pro-benefits">
            	<h1><span><?php echo $lngMocInt;?></span> <?php echo $lngPrgBenifit;?></h1>
                <div class="left-txt">
                	<ul>
                    	<li><?php echo $lngBenifit1;?></li>
                        <li><?php echo $lngBenifit2;?></li>
                        <li><?php echo $lngBenifit3;?></li>
                    </ul>
                </div>
                <div class="right-tutor">
                	<h1><?php echo $lngInterviewers;?></h1>	
                    <div class="rec-cnt" id="banner-slide">
                    	<ul class="bjqs">
          				<?php foreach($suggInterviewers as $interviewer): ?>
						<li>
                    	<h2><a href="<?php echo base_url('/user/profile/uid/'.@$interviewer['uid']); ?>"><?php echo ucfirst(@$interviewer['firstName']).@$interviewer['uid']; ?></a></h2>
                        <h3>
						<?php
						if(@$interviewer['city'] != "" && trim($interviewer['city']) !="")
						{
							echo $interviewer['city'].', ';
						}
						else
						{
							echo @$interviewer['city'];
						}
						if(@$interviewer['provice'] != "" && trim($interviewer['provice']) !="")
						{
							echo  $interviewer['provice'].', ';
						}
						else 
						{
							echo  @$interviewer['provice'];
						}																
						if(@$interviewer['country'] != "" && trim($interviewer['country']) !="")
						{
							echo $interviewer['country'];
						}
						else 
						{
							echo @$interviewer['country'];
                        ...
                        <div class="tutr-cnt">
                        	<div class="tutr-img">
								<?php if($interviewer["pic"] != ''): ?>
								<a href="<?php echo base_url('/user/profile/uid/'.@$interviewer['uid']); ?>"><img src="<?php echo $bbase.'uploads/images/thumb/'.$interviewer["pic"]; ?>" width="100%" height="auto" alt="02" /></a>
								<?php else: ?>
								<a href="<?php echo base_url('/user/profile/uid/'.@$interviewer['uid']); ?>"><img src="<?php echo $bbase.'images/header.jpg';?>" width="100%" height="auto" alt="021" /></a>
								<?php endif; ?>
							</div>
                            <div class="turcnt">
								<?php 
					
									$interviewer['hRate'] = @$interviewer['hRate'] * (1-(-$configdefault['VEE_PRICE_PERCENT']['value']) );
									$interviewer['hRate'] = round(($interviewer['hRate'] *10000) /100)  /100;
									$interviewer['hRate'] = number_format($interviewer['hRate'],2);
									
								
								?>
                            	<span><?php echo $lngRate;?>:</span>
								<p><?php echo $interviewer['hRate'].' Credits/Session'; ?></p>
                            </div>
                            <div class="rec-tutr-btn">
								<a class="icon1 icon-popup"  onclick="sendBeepBoxMessage(<?php echo $interviewer['uid'] ;?>)">&nbsp;<span class="classic"><?php echo $send_message; ?></span></a>
								<a class="icon2 icon-popup" href="<?php echo base_url('/user/calendar/uid/'.@$interviewer['uid']); ?>">&nbsp;<span class="classic"><?php echo $schedule; ?></span></a>
                                <?php if($interviewer['readytotalk'] == 1)
								{?>
								<a class="icon3 icon-popup" onclick="bookNow(<?php echo $interviewer['uid'] ;?>,'<?php echo $interviewer['firstName'];?>')">&nbsp;<span class="classic"><?php echo $talk; ?></span></a>
								<?}else{?>
            ...
            <div class="how-works">
            	<h1><span><?php echo $lHOW_IT ;?></span> <?php echo $lWORKS;?></h1>
                <ul>
                	<li class="orange"><?php echo $lnghiw1;?></li>
                    <li class="blue"><?php echo $lnghiw2;?></li>
                    <li class="green"><?php echo $lnghiw3;?><br><span><?php echo $lnghiw31;?></span></li>
                </ul>
            </div>
        </div>
    </div>
...
jQuery(document).ready(function($) {
  ...
  $('#banner-slide').bjqs({
	...
	$(".icon-popup:not('.icon3-gray')").click(function(){
	  <?php 
	if($this->session->userdata('uid')=="")
	{?>
		alert('<?php echo $YouMust;?>');
		return false;
	<?php
	}?>
  });

...
<?php $this->layout->setLayoutData('content_for_layout_links','<a href="'.base_url('admin/quote_add').'">Add new Quotes</a>');?>
...
<table class="data_table">
    ...
    <?php $j = 0; foreach ($howItworks as $key => $val) :?>
        <tr id="id_<?php echo $val['id'];?>">
            ...
            <td>
            <a href="<?php echo base_url('admin/quote_edit/id/'.$val['id']);?>"><img alt="Edit" src="<?php echo base_url('/images/cm_pencil.png');?>" /></a>
...
setTimeout('showmenu("psettings",18)',1000);
function del(_id){
	if(window.confirm('Are you sure you want to delete this?')){
		$.post('<?php echo Base_url("admin/quote_del")?>',{id:_id},function(msg){

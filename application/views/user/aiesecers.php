...
<div class="index-banner" style="min-height:600px;">
	...
	<div class="stucontainer" style="position:relative;">
		<img src="<?php echo base_url("images/BANNER1.png"); ?>" width="100%" style="border-top:10px solid #d7bc4d; border-bottom:5px solid #d7bc4d">
        <div class="banner_content_main" style=" position:absolute; left:0%; margin:0 auto; width:100%;">
			<h1 class="banner_slogan_1">WELCOME AIESECers! <br/> Don't learn alone...Learn together.</h1>

        </div>
	</div>
	<div class="information" style="text-align:center; width:100%;  padding-top:30px; padding-bottom:27px; color:#fff; margin-top: -1%; background-color:#52565E">
		<h2>Every account can be a tutor or student to earn or learn.</h2>
		<h2>Anyone, anytime, anywhere, and any language.</h2>
	</div>
		<div class="school_main" style="width:90%; margin:0 auto; padding-top:2%;">
			<div style="width:100%; float:left; background-color:#f2f2f2; margin-bottom:25px; padding:3%;">
			<div class="school_left" >
				<div class="school_content_signin" style="margin:0px auto; text-align:center">					
					Join our worldwide community to achieve SDG4 goals together!
				</div>
				
				<div class="school_content_info">
					<div class="sc_info_" style="width:100%;">
					 <!--  <button style="padding:10px; background-color:#32CD32; border:none;">Payments</button>  -->
						<img src="<?php echo base_url("images/buttom-1.png"); ?>" class="sc_info_image">
			...
			<!--	<div class="school_right_content"> -->
					<div  style="width:80%; margin:0px auto; text-align:center; font-size:24px;">  <!-- class="sc_information" -->
						<!-- <h3 style="margin-left:3%; margin-top:2%;"> -->
							Sign up, create a profile, and connect in live video sessions.
<!-- </h3> -->
					</div>
					<div class="school_signupform">
						<form style="display:block;" action="<?php echo Base_url('user/registerDo');?>" method="POST" id="registerFormindx">
							<div class="sf_select" id="rselect1">
								...
								<input type="hidden" name="aff_code" value='u2x223w274'>
							</div>
							...
							<div class="sf_input" id="redmail">
								...
								<span id="email_required" style="color:#DFC964;font-size:15px;font-size:15px;display:none;padding:1em;margin-left:5%; "><b><?php echo $enteremail;?></b></span> <span id="email_invalid" style="color:#DFC964;margin-left:5%;display:none;padding:1em"><b><?php echo $entervalidemail;?></b></span> <span style="color:red;display:none;font-size:17px;margin-top:10px; margin-left:5%;" id="remail"><?php echo $enteremail;?></span> <span style="color:red;display:none;margin-left:5%;font-size:17px;margin-top:10px;" id="vremail"><?php echo $entervalidemail;?></span> <span id="email_taken1" style="color:red;display:none;font-size:17px;margin-top:10px;margin-left:5%;"><b><?php echo $emailTaken;?></b></span> 
							</div>
						    ...
						    <div class="sf_input sf_input_pass" id="rpass">
								...
								<span style="color:red;display:none;font-size:17px;margin-top:40px;margin-left:5%;" id="pass"><?php echo $enterpass;?></span> <span style="color:red;display:none;font-size:17px;margin-top:42px;margin-left:5%;" id="passlong1"><?php echo $sixmin;?></span> 
							</div>
						    ...
						    <div class="sf_input sf_input_pass" id="rcpass">
								...
								<span style="color:red;display:none;font-size:17px;margin-top:40px;margin-left:5%;" id="cpass12"><?php echo $confpass;?></span> <span style="color:red;display:none;font-size:17px;margin-top:33px;margin-left:5%;" id="cpass12d"><?php echo $passmissmatch;?></span> 
							</div>
								<input style="margin-left:5%; cursor:pointer; font-size:26px; background-color:#E26A09; height:72px; width:90%; border:none; color:#fff; border-radius:5px;" name="signup" type="button" onclick="return validateFrm();" value="<?php echo $lSIGN_UP;?>" class="signup_btn" id="registerButton" >
			...
			<div style="width:100%; float:left; text-align:center; font-size:20px;">
				<h3><a href="about_aiesecers" style="color:#037EF3;">LEARN MORE </a>about how can you donate your earnings</h3>
				<h3>to education programs that change people's lives.</h3>
			</div>
			</div>
		</div>
		
		<div class="footer_info" style="width:100%; float:left">
			<div style="text-align:center;float:left;background-color:#037EF3;width: 100%;margin-bottom: 15px;padding: 10px;">
			<div style="width:50%; float:right; text-align:left"><a href="about_aiesecers"><p style="margin-top: 1%; color: #fff; font-size: 16px; margin-left: 2%" >Learn More</p></a></div>
			<div style="width:50%; float:left; text-align:right"><img src="<?php echo base_url("images/aisec_footer.png"); ?>" class="footer_image" >
			</div>

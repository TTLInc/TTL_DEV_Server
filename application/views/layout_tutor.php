...
<?php include_once FCPATH."idle/idle.php";?>
    ...
    <!--SIGNUP FORM END -->
    <?php
	$current_uri1 = $this->uri->segment(1);
			$arrVal 	= $this->lookup_model->getValue('1236', $multi_lang);		$BE_A   		= $arrVal[$multi_lang];
			?>
    <div class="header">
    	<div class="wrapper clearfix">
        	<a href="<?php echo base_url();?>"><img src="<?php echo Base_url("images/main/logo-big.gif");?>" alt="The TalkList" title="The TalkList" class="logo"></a>

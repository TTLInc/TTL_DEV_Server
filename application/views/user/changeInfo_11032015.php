...
function ValidatePass()
{
	...
	var ConfPass=$("#new_repassword2").val();
	if(Pass !='')
	{
		if(ConfPass == '')
		{
                            ...
                            <div class="pro-settg">
                            	<div class="tab-nav">
                                	<ul>
										...
										<li id="DynamicCall" onClick="showHide('con4'); hide();" class="<?php if($currentTab == "col4"){ echo 'active';}?>"><?php echo $lFINANCIAL;?></li>
                                        <?php endif;?>
...
<form name="cancelInfoFrm" id="cancelInfoFrm" action="<?php echo Base_url('user/changeInfo');?>" method="POST">
								...
								<?php //echo $currentTab;?>
									...
									<form action="<?php echo Base_url('user/changeInfo');?>" method="POST"  onsubmit="return validateFormCon4();">
                                       ...
                                       <div class="student-hight6">
                                        ...
                                        <div class="cnt-rw high-cnt-chin">
                                            ...
                                            <input id="alinks" autocomplete="off" readonly  name="a_link" type="text" value="<?php echo $encode;?>"/> 
                                        </div></div>
                                        </div>
										 <?php if($profile['roleId'] ==0){?>
										<div class="cnt-rw">
                                   ...
                                   <div class="sub-cnt" id="con6" style="display:<?php if($currentTab == "col6"){ echo 'block';}else{ echo 'none';}?>;">
										<!--<form action="<?php echo Base_url('user/changeInfo');?>" method="POST" onsubmit="return validateFormCon2();">-->
										<form action="<?php echo Base_url('user/changeInfo');?>" method="POST"  id="passchangeform">
										<div class="cnt-rw">
                                        	<label><?php echo $lnewpwd;?>:</label>
                                            <input autocomplete="off"   name="new_password" type="password" value="" id="new_password"  placeholder="******" />
                                        </div>
                                        ...
                                        <div class="cnt-rw no-brd">
                                        	<label>&nbsp;</label>
                                            <!--<input type="submit" value="<?php echo $lsave;?>" class="st-btn"> <input type="button" value="<?php echo $lCANCEL;?>" class="st-btn" onclick="cancelInfo();">-->
											<input type="button" onclick="ValidatePass();" value="<?php echo $lsave;?>" class="st-btn"> <input type="button" value="<?php echo $lCANCEL;?>" class="st-btn" onclick="cancelInfo();">
                                        </div>
									<input type="hidden" name="profile_tab" value="col2">
									</form>
									</div>
	...
	<div id="firstTour" title="" style="display:None;">
			 <div class="popup-step tutoe-step5">
                ...
                <span class="popup-no">5</span>
                	<div class="ratelist popup-row" style="margin:0 0 0px !important">

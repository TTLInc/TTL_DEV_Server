        ...
        <div class="signup_form" id="signup_form2">
            <div class="sf_padding">
	            ...
	            <form style="display:block;" action="<?php echo Base_url('user/registerDo');?>" method="POST" id="registerForm123">
		            ...
		            <input name="signup" type="button" onclick="frmvalidate1();"  value="<?php //echo $lSIGN_UP;?> Sign Up" class="signup_btn" id="registerButton21" >
...
<div class="header">
		...
		?>
			...
			<div class="navi_col navi_col2 top_link_hover"><ul id="top_navi"><li><a class="top_link2 my-pages" href="<?php echo Base_url("user/dashboard");?>"><?php echo $profile;?></a></li></ul></div>
			 <?php }?>
				...
				<a class="mrg-lft" id="xOutUser" href="<?php echo Base_url("user/logout");?>"><?php echo $llogout;?></a>
   ...
   <?php }?>
    ...
    <div class="page_title">
		...
		{ ?>
		<span><h5 class="pro-reco"><a href="<?php echo base_url('/user/profile/uid/'.@$current_uri4); ?>"><span <?php if($this->uri->segment(2)=='profile') {?>class="urlblue" <?php }?>>Profile</span></a><br><br><a <?php if($this->session->userdata['uid']!=''){?> href="<?php echo base_url('/user/lessons/uid/'.@$current_uri4); ?>" <?php } else {?> onclick="theFunction()" <?php }?> style="cursor:pointer;"><span <?php if($this->uri->segment(2)=='lessons') {?>class="urlblue" <?php }?>>Recordings</span></a></h5></span>
		
			<div class="tutrpg-icon">
		<div class="session-dv">
		<span class="session-type">Session Type <span class="classic">Select Conversation for informal speaking practice. Select curriculum to use a school sponsored formal program.</span></span>
		<select  id="stype" name="stype" class="chngurl" onchange="chngurl(this.options[ this.selectedIndex ].value);">
...
<div class="footer">
	<div class="wrapper clearfix">
		...
		<div class="footer_links">
			...
			<a href="<?php echo Base_Url('article/about');?>"><?php echo $affiliate;?></a> 

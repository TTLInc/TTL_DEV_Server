...
.clickdisplay{width:147px !important;height:133px;}
	...
	$(function(){
		...
		var _data1 = {subject:'Request schedule',message:' is requesting '+days_date+' at '+selected_slot+' ',uidurl:_uidurl,sTopic : sessionTopic , sLevel : sessionLevel,eventdat:days_date,eventtime:selected_slot};
				...
				//	alert(JSON.stringify(msg));
					...
					$.each(s.rows,function(k,v){
						...
						if(s.rows[k].stid!='undefined' && typeof(v.sid)=='undefined' ){
							...
							status = '<?php echo "Already Requested";?>';

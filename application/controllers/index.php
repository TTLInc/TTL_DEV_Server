...
class Index extends TL_Controller {
	...
	public function index(){
		$this->load->model(array('banner_model','ppc_model','user_model','testimonial_model','lesson_model'));
	...
	public function promosignup(){
		...
		$this->layout->setData('SchoolInfo',$SchoolInfo);
		$this->layout->setLayout('layout_index');
		$this->layout->view('index/promosignup');
	}

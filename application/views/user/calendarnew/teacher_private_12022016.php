...
var rollId='<?php echo $this->session->userdata('roleId'); ?>'; 
	if(a ==2 && rollId >=1 && rollId <=3 && x!='')
	{
		...
		$('#sloat_0').css('z-index', '999999' );
		$('#sloat_0').css('position', 'relative' );
		$('#sloat_1').css('z-index', '999999' );
		$('#sloat_1').css('position', 'relative' );
		$('#sloat_2').css('z-index', '999999' );
		$('#sloat_2').css('position', 'relative' );
		$('#sloat_3').css('z-index', '999999' );
		$('#sloat_4').css('position', 'relative' );
        	...
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp" class="cld-txt">
									...
									<div class="rating_ct">
										...
										<div class="classes_info clearfix f12 fb">
											<span class="fl">
												...
												{
													echo "Your Student: ".$class['firstName'].$class['sid']; ?> <br> <br><?php echo  hiaOutTime($class['startTime']) ;
												}
												else
												{
													$tutorDetails = $this->user_model->getnameByUid($class['tid']);
													echo "Your Tutor: ".$tutorDetails['firstName'].$class['tid'] ?> <br> <br><?php echo  hiaOutTime($class['startTime']) ;
												}?>
											</span>
					...
					<?php if($uri ==''){?>
					  <div class="mod">
		            <div class="hd">
					 <?php if($classes==array()){?><hr style="color:#D7BC4D !important;border-top: 2.5px solid #D7BC4D;" /><?PHP }?><span style="margin-left:200px;font-size:14px;font-weight: bold;"> <?php echo $ClickToslot;?></span>
					</div></div>
                	<div class="mod clndr-pg">
                        <div class="hd">
                            <div class="pro_tle tle "><h3><span class="ltimez" style="width:345px;"><?php echo $lcalender;?> (<?php echo $lLOCAL_TIMEZONE;?>)</span><div style="padding-top:0px;float: left;"><a href="<?php echo base_url('support/resources/tut'); ?>" style="display:pointer"><span class="svideo"><img style="width:31px;" src="<?php echo base_url('images/blue-ply-icon.jpg');?>"></span></a></div><span class="ToolCal"><img style="float:right;" src="<?php echo Base_url('images/arrow.png') ?>" /></span></h3></div>
							
							<span class="three-why mrbt"><?php echo $threeway?> </span>
							<div class="cl-new-why" >
							  <div class="cl-bking">
                              	<span>
                                	<input type="checkbox" name="readytotalk1"  <?php if(@$profile['readytotalk']=='1'){echo 'checked';} ?> id="readytotalk1"/>
                                    <label><?php echo $Nows ;?></label>
                                </span>
                                <p><?php echo $RealTimeBooking;?></p>	
                              </div>
                              <div class="cl-tmlot">
                              	<span><a><?php echo $opens ;?></a></span>
                              	<p><?php echo $AvailableSlot;?></p>
                              </div>
                              <div class="cl-resession">
                              	<a class="blu-btn rcr-ses" style="cursor:pointer"><?php echo $lRECURRING_SESSION;?></a>
                                <p><?php  echo $MonthCal;?></p>
                              </div>
								<!--<div class="clk-btn">
									...
									<div class="rating_ct">
										...
										<div class="classes_info clearfix f12 fb">
											<span class="fl">
												...
												<?php //echo $class['firstName'].$class['sid']?><br><br><?php //echo  hiaOutTime($class['startTime']) ;?>
											</span>
											<span class="c06a0c1">&nbsp;&nbsp;</span>
											<span class="c06a0c1" id="join-vee-session">
...
$( "#messageIe" ).dialog( "destroy" );
 ...
 //if($(this).hasClass('Open')){
	...
	$( document ).ready(function() {
		$( '#bNote' ).html('');
		$( '#bNote' ).html('<img src="<?php echo base_url("images/orange-dot.png");?>"> = <?php echo $lBOOKING;?>');
	});
	//--Set Language for Booking
...
<div id="firstTour" title="" style="display:None;">
	...
	<div class="popup-step tutoe-step2">
		...
		<div class="step-div-bg">
			<div class="ratelist popup-row margp">
				<h2 class="poupttl martop25">
					<?php
					$arrVal = $this->lookup_model->getValue('1348', $multi_lang);
					$lngSetAvail = $arrVal[$multi_lang];
					echo $lngSetAvail;
					?>
				</h2>
				<p>

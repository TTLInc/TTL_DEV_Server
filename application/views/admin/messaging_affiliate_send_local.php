<?php $this->layout->setLayoutData('content_for_layout_title','Send Affiliate Message');?>
...
<form method="post" action="" name="sendMassmessageform" id="sendMassmessageform" enctype="multipart/form-data">
	...
	-->
	<input type="hidden" name="sendtype" value="email" id="sendtype" />
...
setTimeout('showmenu("adminmessages",1)',1000);

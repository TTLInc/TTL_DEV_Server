<?php $this->layout->setLayoutData('content_for_layout_title','Notifications');?>
<?php $this->layout->setLayoutData('content_for_layout_links','<a href="'.base_url('admin/addnotifications').'">Add New</a>');?>
<table class="data_table">
    ...
    <tbody>
    <?php $j = 0; foreach ($notifications as $key => $val) :?>
        <tr id="id_<?php echo $val['id'];?>">
            ...
            <td>
            <a href="<?php echo base_url('admin/addnotifications/'.$val['id']);?>">
...
function del(_id){
	if(window.confirm('Are you sure you want to delete this?')){
		$.post('<?php echo Base_url("admin/delnotifications")?>',{id:_id},function(msg){

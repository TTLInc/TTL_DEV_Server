<?php $this->layout->setLayoutData('content_for_layout_title','Edit Contest');?>
<?php if(@$errormsg):?>
...
<?php endif;?>
<form method="post" action="" name="editContestform" id="editContestform" enctype="multipart/form-data">

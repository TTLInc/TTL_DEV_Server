...
<div class="index-banner" style="min-height:600px;">
	...
	<div class="stucontainer" style="position:relative;">
        ...
        <div class="banner_content_main" style=" position:absolute; top:60px%; left:0%; margin:0 auto; width:100%;">
			<h1 class="banner_slogan_1">We amplify vibrant student communities.</h1>
					...
					<div class="school_signupform">
						<form style="display:block;" action="<?php echo Base_url('user/registerDo');?>" method="POST" id="registerFormindx">
							...
							<div class="sf_input" id="redfname">
								<input style="width:90%; margin-left:5%; margin-top:3%; background-color:inherit; height:35px; border:2px solid #ccc; padding-left:20px" id="firstName" type="text" value="" name="firstName" placeholder="<?php echo "Organization Name";//$lFIRSTNAME;?>" size="25" class="txtbox" />
								<span style="color:red;display:none;margin-left:5%;font-size:17px;padding-top:10px;" id="fname"><?php echo $enterfname;?></span> <span id="firstName_required" style="color:#DFC964;margin-left:5%;font-size:15px;display:none;"><b><?php echo $enterfname;?></b></span> 
							</div>

...
class Signupnow extends TL_Controller {
	...
	public function index(){
		...
		$SchoolInfo=array();
		  ...
		  {
           $decode =  $this->user_model->decode($refid_encode,"This is a key"); 
		...
		//echo "<pre>"; print_r($nextSession);DIE;
		...
		$this->layout->view('signupnow');
	}
	 
	
}
/* End of file signupnow.php */

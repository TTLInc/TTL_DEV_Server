 ...
 <div class="baseBox baseBoxBg clearfix">
        	...
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp" style="margin-top:25px !important;">
                    ...
                    <div class="mod">
                            ...
                            <div class="content tle"><h2><?php echo $llesson;?></h2></div>
                        
		                <div class="video_intro_desc">
		                	<?php echo $llesson_text;?>
		                </div>
						...
						<div class="bd">
							...
							<ul class="archivedList lessonsList">
								...
								<li class="lesson">
									<div class="video_pic_163x90 posR fl"><a href="javascript:void(0)"><img src="<?php echo profile_video($lesson['source']);?>" width="163" height="90" /><span class="video_ic video_ic_s"></span></a></div>
									<div class="video_pic_intro c666">
										<div class="video_hd clearfix">
											<h3 class="c424242 f14 fl">
												...
												- <?php echo $lprice;?> <span class="cbd0000 lprice" >$<?php echo $lesson['price'];?></span>
											</h3>
										</div>
									...
									<div class="set_price">
										...
										<div class="addBtn_Wp">
										<a class="addmore_v_btn redRadiusBtn2 w80 setPrice" href="javascript:void(0)"><?php echo $lsetprice;?></a>
										<a class="addmore_v_btn redRadiusBtn2 w55 deleteLesson" href="javascript:void(0)"><?php echo $ldelete;?></a>
										</div>
									</div>
								</li>
								<?php endforeach;?>
								...
								<li class="addnewTemplate" style="display:none">
									...
									<a href="#">
									<img src="<?php echo Base_url('images/clicktoupload.jpg');?>" width="140" height="120" />
									...
									<div class="video_pic_intro c666">
										<div class="video_hd clearfix">
										<h3 class="c424242 f14 fl">
										<?php echo $llesson_name;?>:<input type="text" class="lesson_name" placeholder="Lesson Name"> 
										</h3>
										</div>
										<div class="archived_desc">
										<strong><?php echo $ldescription;?>: </strong> <br/>
									...
									<div class="set_price">
									<?php echo $lsetprice;?><br />
									$ <input type="text" class="new_prize_ipt price" />
									<input type="hidden" value="0" class="lesson_id"/>
									<div class="addBtn_Wp">
									<a href="javascript:void(0)" class="addmore_v_btn redRadiusBtn2 w96 doAddLesson"><?php echo $ladd;?></a>
						...
						<!--Add Video-->						
						<div class="bd"><div class="addBtn_Wp"><a href="javascript:void(0)" class="addmore_v_btn redRadiusBtn2 w96" onclick="addLessons()"><?php echo $laddmore;?></a></div></div>
						<!--Add Video-->
	...
	function addLessons(){
		if(<?php echo $profile['roleId'];?> != 3 ){
			alert('Video Sales are reserved for Gold tutors. You can purchase an upgrade on your Account page.');
			return;
		}
	...
	$(function(){
		...
		if( typeof(_firstLesson.get(0)) == 'undefined' || _firstLesson.attr('source')==''){
			...
			createVideo('<?php echo profile_video("");?>','http://thetalklist.com/uploads/video/2013/05/27/768133c57f817a1819e6cf699b025b58.mp4','Default vedio');
		}

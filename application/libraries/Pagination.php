...
class CI_Pagination {
	...
	function create_links()
	{
		...
		$sortorder = $this->urlSegment(7);
		if(!$sortorder)
		{
			$sortorder = 'desc';
		}
		
		$sort = $this->urlSegment(9);
		// if(!$sort)
		// {
			// $sort = 'id';
		// }
		...
		if  ($this->prev_link !== FALSE AND $this->cur_page != 1)
		{
			...
			{
				$output .= $this->prev_tag_open.'<a '.$this->anchor_class.'href="'.$this->first_url.$sorturl.'">'.$this->prev_link.'</a>'.$this->prev_tag_close;
			}
			else
			{
				$i = ($i == 0) ? '0' : $this->prefix.$i.$this->suffix;
				$output .= $this->prev_tag_open.'<a '.$this->anchor_class.'href="'.$this->base_url.$i.$sorturl.'">'.$this->prev_link.'</a>'.$this->prev_tag_close;
			}
		...
		if ($this->next_link !== FALSE AND $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open.'<a '.$this->anchor_class.'href="'.$this->base_url.$this->prefix.$i.$this->suffix.$sorturl.'">'.$this->next_link.'</a>'.$this->next_tag_close;
		}

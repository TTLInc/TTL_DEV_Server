                ...
                <div id="student_prof_Wp">
                    <div class="mod">
                        <div class="hd">
							...
							<div class="agnR">
									<a class="norBtn whiteRadiusBtn w96" id="discard" onclick="dgClose();"><?php echo $discardtext; ?></a>
                                    <a class="norBtn redRadiusBtn2  w96" id="send" onclick="sendMessage();"><?php echo $sendtext; ?></a>
                            </div>
                        </div>
                    </div>
                </div>

                            ...
                            <div class="pro-settg">
                            	<div class="tab-nav">
                                	<ul>
										...
										<li onClick="showHide('con5'); hide();" class="<?php if($currentTab == "col5"){ echo 'active';}?>"><?php echo "School Description";?></li>
...
<form name="cancelInfoFrm" id="cancelInfoFrm" action="<?php echo Base_url('user/myInfo');?>" method="POST">
								...
								<?php //echo $currentTab;?>
									...
									<form action="<?php echo Base_url('user/myInfo');?>" method="POST"  onsubmit="return validateFormCon3();">
										...
										<div class="cnt-rw">
                                        	<label><?php echo "Tutor Markup";?>:</label>
                                            <input autocomplete="off" onkeypress="return chknum1(event)"  type="text" value="<?php echo '$'.$profile['tutor_markup']=number_format($profile['tutor_markup']['hRate'],2,'.','');?>" id="tutor_markup" maxlength="5" name="tutor_markup"/> 
                                        ...
                                        <div class="cnt-rw">
                                        	<label><?php echo "Referral Link";?>:</label>

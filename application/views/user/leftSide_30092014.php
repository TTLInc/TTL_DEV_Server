...
$(".AffiTool").hover(function () {
			 $(this).append("<div class='tooltip-payment'><p><?php echo  "Share this affiliate URL to have new member payments credited to your account."; ?></p></div>");
				}, function () {
...
.AffiTool {cursor: pointer;display: inline-block;width: 10px;height: 10px;line-height: 10px;font-size: 13px;font-weight: bold;border-radius: 4px;text-align: center;position: relative; float:right;}
.AffiTool img {vertical-align : middle;}
	   ...
	   var button12 = $('#new_upload_video_lnk_true'), interval1;
		new AjaxUpload(button12,{
			...
			onSubmit : function(file, ext){
				...
				if(ext == 'mp4'|| ext == 'avi' || ext == 'flv'|| ext == 'rm'|| ext == 'wma'|| ext == 'rmvb'|| ext == '3gp'|| ext == 'wmv'){
				}else{
		...
		<div class="slide_inner">
			...
			<div class="user_info">
				...
				<span  style="top:30px;font-size:20px;font-weight:bold;"><?php echo $profile['firstName'];?></span>
					...
					<?php  if($profile['roleId'] == 5 || $profile['roleId'] == 4){?> <p style="font-size:11px; width:300px" class="AffiTool"><?php  echo $encode;?></p> <?php }?> 
				  ...
				  if($this->session->userdata['roleId'] == 1 || $this->session->userdata['roleId'] == 2 || $this->session->userdata['roleId'] == 3) {?>
							...
							<span class=""><a  id="vupld" href="#" <?php if($pinfo['vedio']!=''){ ?>class="golden-btn-icon bknw"<?php }else {?>class="golden-btn-wicon bknw"<?php } ?> style="cursor: default;width:116px;margin-bottom:5px" ><?php echo "2"." ".$vgreeting;?></a></span><br />
							...
							<span class=""><a href="<?php echo base_url('user/calendar');?>" <?php if($openedslot['oslot'] > 0){ ?>class="golden-btn-icon bknw"<?php }else {?>class="golden-btn-wicon bknw"<?php } ?> style="cursor: default;width:92px;margin-bottom:5px" ><?php echo "4". " "."Calendar Opening";?></a></span><br />
							</span>
							<?php }?>
					...
					<!-- end tutor profile -->
						...
						<?php if($adcon): ?>
                                        ...
                                        <div class="" style="overflow:hidden; width:260px;height:150px; float:left;border-bottom: 4px solid #D7BC4D;padding:0px 0px 30px 0px;">
					...
					<?php
						...
						<?php if($adcon1): ?>
                         <div class="" style="overflow:hidden; width:260px;height:160px; margin-top:1px !important;float:left;border-bottom: 4px solid #D7BC4D;padding:20px 0px 20px 0px;">

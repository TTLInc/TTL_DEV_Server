 ...
 <div class="baseBox baseBoxBg clearfix">
        <div class="content_main fr">
			...
			<?php if($uri ==''){?>
                	<div class="mod">
                        <div class="hd">
                            <div class="pro_tle tle"><h3><span class="ltimez" style="width:345px;"><?php echo $lcalender;?> (<?php echo $lLOCAL_TIMEZONE;?>)</span><a href="<?php echo base_url('support/resources/stu'); ?>" style="display:pointer"></a></h3></div>
                        </div>
						<!--<div class="bd">

<?php $this->layout->setLayoutData('content_for_layout_title','FAQ list');?>
<?php $this->layout->setLayoutData('content_for_layout_links','<a href="'.base_url('admin/faq_add').'">Add new FAQ</a>');?>
...
<table class="data_table">
	...
	<tbody>
	<?php $j = 0; foreach ($faqs as $key => $val) :?>
	<tr id="id_<?php echo $val['id'];?>">
		...
		<td>
		<a href="<?php echo base_url('admin/faq_edit/id/'.$val['id']);?>"><img alt="Edit" src="<?php echo base_url('/images/cm_pencil.png');?>" /></a>
...
<script type="text/javascript">
	setTimeout('showmenu("faq",0)',1000);
	function del(_id){
		if(window.confirm('Are you sure you want to delete this?')){
			$.post('<?php echo Base_url("admin/faq_del")?>',{id:_id},function(msg){

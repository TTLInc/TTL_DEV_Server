        	...
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp">
                    <div class="mod">
                          ...
                          <div class="content"><h2><?php echo "Recordings";?></h2></div>
                     
                        <div class="video_intro_desc"><?php echo "Purchasing a video will make a copy in your Recorded Videos page  that you can repeatedly view.";?></div>
                        <div class="bd">

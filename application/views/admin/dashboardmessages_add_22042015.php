<?php $this->layout->setLayoutData('content_for_layout_title','Add Message');?>
...
<form method="post" action="" name="addVideoform" id="addVideoform" enctype="multipart/form-data">
	...
	<p class="ft_title">Image <span>(Ideal image width and height should be 345px by 389px and upload only jpg,gif or png file.)</span></p>

<?php $this->layout->setLayoutData('content_for_layout_title','Add Suggested Tutor');?>
...
$.ajax({
					  type:'POST',
					 dataType: 'html',
					  url:'<?php echo base_url('admin/GetNewtutorsAdmin');?>',
					  data:pattern,
...
//alert(id);return false;
	...
	$.ajax({
		  type:'POST',
		  data:cupdate,
		  url:'<?php echo base_url('admin/AddnewTutor/');?>',
		  success:function(msg){
		  ...
		  if(json.success){					  
			alert('Suggested tutor is added.');
			window.location.href = '<?php echo Base_url("admin/addtutor");?>';
			}
		  else
		  {

...
$arrVal 	= $this->lookup_model->getValue('1034', $multi_lang);	$PurchageVideo   	= $arrVal[$multi_lang];
?>
        	...
        	<div class="main_inner">
                ...
                <div id="teacher_prof_Wp">
                    <div class="mod">
                          ...
                          <div class="content"><h2><?php echo $Recording;?></h2></div>
                     
                        <div class="video_intro_desc"><?php echo $PurchageVideo;?></div>
                        <div class="bd">
                            <ul class="archivedList lessonsPubList">
								...
								<li  class="lesson">
                                	<div class="video_pic_163x90 posR fl">
                                    	<a href="javascript:void(0)"><img src="<?php echo base_url("uploads/video/".$lesson['source'].".jpg");?>" width="163" height="90" /><span class="video_ic video_ic_s"></span></a>
                                    </div>
                                    <div class="video_pic_intro c666">
                                    	<div class="video_hd clearfix">
	...
	$(function(){
		$('.buyClass').click(function(){
			...
			$.post('<?php echo base_url("user/buy_lesson");?>',_data,function(msg){
				...
				else if(json.status == false || json.status == 'false'){
...
var mu_uid = $("#uid").val();
 ...
 //$('#dialog').html('updating');
	//$('#dialog').attr('buttonType','doing');
	$('#dialog').dialog({modal:true});
  $('#dialog').html('Please Sign Up to engage tutor.');
  $( ".floating_form" ).show();
 }
 else
 {

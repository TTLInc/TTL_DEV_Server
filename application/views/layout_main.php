...
if($this->uri->segments[0] != 'en'){
	...
	header("Location: http://dev.thetalklist.com/en".$request);
}
*/
...
?>
<!doctype html>
<html xmlns="http://dev.w3.org/1999/xhtml" lang="en">
...
<link id="bico" type="image/x-icon" href="http://dev.thetalklist.com/images/talklist.ico" rel="bookmark">
<link id="bsico" type="image/x-icon" href="http://dev.thetalklist.com/images/talklist.ico" rel="shortcut icon">
...
<!--<script src="http://dev.thetalklist.com/js/home/jquery-1.8.2.js" type="text/javascript"></script> -->
...
<div class="footer">
	<div class="wrapper clearfix">
		...
		<div class="footer_links">
			...
			<a href="http://dev.thetalklist.com/sitemap.xml"><?php echo $site;?></a> 
		</div> 
	</div>
</div>
...
function jsonpCallback(data){ 
 location.reload();
 //window.location.href = 'http://dev.thetalklist.com';
}*/
...
olark.identify('9086-704-10-4711');/*]]>*/</script><noscript><a href="http://dev.olark.com/site/9086-704-10-4711/contact" title="Contact us" target="_blank">Questions? Feedback?</a> powered by <a href="http://dev.olark.com?welcome" title="Olark live chat software">Olark live chat software</a></noscript>
<!-- end olark code -->
...
<style>
.showVideo img{
	width:234px!important; height: 100px;!important"
}

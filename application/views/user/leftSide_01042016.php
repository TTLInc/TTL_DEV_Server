...
<div id="sendMessageView" class="sendMessageView" style="display:none;"></div>
	<div class="content_side fl" style="float:left; width:320px;">
		<div class="slide_inner">
			...
			<div class="user_info">
            	<?php if(!$own):?>	<?php echo mailAptBtn($chkfreesession,$profile['uid']); ?><?php endif ;?>
				<span  style="top:30px;font-size:20px;font-weight:bold;" class="tutr-nm"><?php echo $profile['firstName'].$profile['uid'];?></span>
					...
					<?php  if($profile['roleId'] == 5 || $profile['roleId'] == 4){?> <p style="font-size:11px;" class="AffiTool"><span><?php  echo str_replace(" ","-",$encode);?></span></p><?php }?> 
						...
						<?php if($profile['readytotalk']==1){?>
                                <a class="icon-tk-nw icon-popup icon3-red icon2 bkclass" onClick="bookNow(<?php echo $current_uri4 ;?>,'<?php echo $profile['firstName'];?>')">&nbsp;<span class="classic"><?php echo $talk; ?></span></a>
                        <?php } else {?>
				  ...
				  <?php
				  if($otheruser != 1){
					if(($this->session->userdata['roleId'] == 1 || $this->session->userdata['roleId'] == 2 || $this->session->userdata['roleId'] == 3) AND $this->session->userdata['uid'] != '2') {?>

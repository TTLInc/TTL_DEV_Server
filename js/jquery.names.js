...
$.editable.addInputType('locations', {
    element : function(settings, original) {
		...
		if(role == '0')
		{
			var input = $('<span><select class="country"></select> <input class="city" value="City"  placeholder="City" /></span>');
        }else 
		{
			var input = $('<span><select class="country"></select> <select class="provice"></select> <input style="margin-top:3px;" class="city" value="City" placeholder="City"/></span>');
		}
        $(this).append(input);

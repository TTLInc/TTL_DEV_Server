...
<form method="post" action="" name="articleform" id="articleform" >    
	...
	<p class="ft_title"><?php echo $config['Private use Fee']['desc'];?></p>
    <p class="setft">
    	<input type="text" name="config[8][value]" id="title" value="<?php echo $config['Private use Fee']['value'];?>"  class="adm_box1" />
    	<input type="hidden" name="config[8][key]" id="title" value="Private use Fee"  class="adm_box1" />
   		<input type="hidden" name="config[8][id]" id="title" value="<?php echo $config['Private use Fee']['id'];?>"  class="adm_box1" />
   	</p>
	
	<p class="ft_title"><?php echo $config['Mobile_promotional_credit']['desc'];?></p>
    <p class="setft">
    	<input type="text" name="config[9][value]" id="title" value="<?php echo $config['Mobile_promotional_credit']['value'];?>"  class="adm_box1" />
    	<input type="hidden" name="config[9][key]" id="title" value="Mobile_promotional_credit"  class="adm_box1" />
   		<input type="hidden" name="config[9][id]" id="title" value="<?php echo $config['Mobile_promotional_credit']['id'];?>"  class="adm_box1" />
   	</p>
...
setTimeout('showmenu("financial",6)',1000);
</script>
</body>
</html>
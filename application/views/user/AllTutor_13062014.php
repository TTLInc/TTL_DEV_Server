            ...
            <div id="student_prof_Wp">
                ...
                <div class="mod">
					<?php if($profile['roleId'] == 4){ ?>
                        ...
                        <div class="content tle"><h2>Add Tutor</h2></div>
                    ...
                    <div class="bd">
					  ...
					  <input type="text" placeholder="Search by name or email" onkeyup="getall(this.value);" id="searchTxt">
					  </div> 
					<a style="float:left;margin:0px" class="cancelbtn" href="<?php echo base_url('user/account') ?>">Cancel</a>
...
function AddTutor(id,oid){
    ...
    document.getElementById(json.hid).style.display ='none';
// $('#hdivadd').hide('slow');

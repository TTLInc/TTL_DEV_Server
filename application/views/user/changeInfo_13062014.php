								...
								<?php //echo $currentTab;?>
									...
									<form action="<?php echo Base_url('user/changeInfo');?>" method="POST"  onsubmit="return validateFormCon4();">
                                        ...
                                        <div class="cnt-rw">
											...
											<option value="y" <?php if(@$free_session[$profile['free_session']] == 'y'){ echo 'selected="SELECTED"';};?>><?php echo $lP_YES;?></option>
											<option value="n" <?php if(@$free_session[$profile['free_session']] == 'n'){ echo 'selected="SELECTED"';};?>><?php echo $lP_NO;?></option>
											</select>
									   ...
									   <?php }?>
                                        ...
                                        <div class="cnt-rw">
										 ...
										 <?php if($profile['roleId'] ==0){?>
										<div class="cnt-rw">
                                        	<label class="payment-mode"><?php echo "Payment mode";?>:</label>
											<input class="sm-input" type="radio" checked  name="payment_type" <?php if($profile['payment_type'] == 'paypal'){ echo "checked";}?> value="paypal" >PayPal money transfer <br>
                                            <input class="sm-input" type="radio" name="payment_type"  <?php if($profile['payment_type'] == 'credits' || $profile['payment_type']==''){ echo "checked";}?> value="credits">TheTalkList credits (greater value)
...
var a= confirm("Are you sure you want to remove yourself from the school account?");
if(a)
{
   var cupdate = uid;
...
// $('#hdivadd').hide('slow');
 alert('You are no longer a member of this school.');
 location.reload(); 

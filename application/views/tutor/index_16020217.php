...
<link rel="canonical" href="https://www.thetalklist.com/en/tutor/" />
</head>
<?php
$multi_lang = 'en';
if(!isset($_SESSION)) {
...
<!--SIGNUP FORM START -->
            ...
            <div class="sf_padding">
	            ...
	            <form style="display:block;" action="<?php echo Base_url('user/registerDo');?>" method="POST" id="registerForm1">
	            	<div class="sf_select" id="rselect">
						<input type="hidden" name="roleId" id="roleId1" value='1'>
					</div>
    ...
    <div class="page_title wht-ttl">
    	<div class="wrapper for-staticpg"><div class='tuth1class'><!--Tutor Details--><?php echo $lTUTOR_DETAILS?></div></div>
    </div>
    <!--PAGE TITLE END -->
    	...
    	<div class="wrapperinner tutor-pg">
            ...
            <div class="image_left vid_btn">
	            <?php /*?><a href="#">
				  ...
				  <video id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="auto" width="305" height="170" poster="<?php echo Base_url("images/main/become_tutor.jpg");?>" data-setup='{}'>
            ...
            <div class="levels_table clearfix">
            	<div class="lt_row lt_row_header clearfix">
                	...
                	<div class="lt_col_4"><div class="lt_padding"><!--Sell Videos--><?php echo $lSELL_VIDEOS;?></div></div>
                	<div class="lt_col_5"><div class="lt_padding"><!--e-Trained--><?php echo $lE_TRAINED;?></div></div>
                ...
                <div class="lt_row lt_row_margin clearfix">
                	...
                	<div class="lt_col_7"><!--$30/mo--><?php echo $lFREE;?></div>
                </div>
            </div>
            ...
            <div class='tutpage'><h1>Earn a tutoring income</h1></div>

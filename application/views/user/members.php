		...
		<div style="width:1086px; margin:0 auto;" >
		   ...
		   <div style="width:100%; float:left;  border-bottom: 3px dotted #D3D3D3; ">
				<div style="width:85%; float:left" class="hd">
					<div class="content"><h2 style=" border-bottom: 0px dotted #D3D3D3; font-size:22px;"><span style="color:#E8B800">Affiliate List</span> <a href="#" class="export">[Export]</a> </h2></div>

				</div>
					
				
				<div style="height:52px;">
					<a href="#" class="show_hide"  style="float:right; font-size:28px;"><span id="plus" style="padding-top: 15px; font-size:25px;" class="glyphicon glyphicon-triangle-bottom"></span></a>
				</div>
			</div>

			
		<div class="slidingDiv" style="width:100%; float:left; padding-bottom: 50px;">
			<div id="table-wrapper">
				<div id="table-scroll">
					...
					<tr style="width:100%; background-color:#D3D3D3; font-size:18px; color: #fff; height:52px; padding:15px 5px;">
						<td style="width:15%;"><span style="padding: 15px 10px;" class="text" >Affiliate ID</span></td>
						<td style="width:20%;"><span style="padding: 15px 10px; width:21%;" class="text1">Affiliate Name</span></td>
						<td style="width:20%;"><span style="padding: 15px 10px; width:21%;" class="text">Country</span></td>		
						<td style="width:30%;"><span style="width:30%; padding: 15px 10px;" class="text">Email</span></td>
						<td style="width:20%;"><span style="width: 15%; padding: 15px 10px; text-align:center" class="text2">Redemptions</span></td>				
				   ...
				   <?php
					if(empty($info)){ ?>
						<tr style="width:100%; font-size:16px;">	
							<td colspan="5" style="width:100%; padding: 15px 10px; text-align:center;">No Affiliate members registered yet.</td>
						</tr>
			<?php 	}else { ?>
					...
					<?php foreach($info as $res){ ?>
						<tr style="padding:15px 10px;">	
							...
							<td style="width:10%;  padding: 15px 10px;"><?php echo $res->affiliate_id; ?></td>
							<td style="width:15%;  padding: 15px 10px;"><?php echo $res->affiliate_name; if($res->organizationName != ''){echo '-'.$res->organizationName;}  ?></td>
							<td style="width:10%;  padding: 15px 10px;"><?php echo $res->country;?></td>
							<td style="width:10%;  padding: 15px 10px;"><?php echo $res->email; ?></td>
							<td style="width:10%;  padding: 15px 10px; text-align:center"><?php echo $res->credit_value; ?></td>
			...
			<div class="slidingDiv_tutor" style="width:100%; float:left; padding-bottom: 50px;">
				...
				<table style="width:100%; font-size:16px;">
				<tr style="width:100%; background-color:#D3D3D3; font-size:18px; color: #fff; height:52px; padding:15px 5px;">
					<td style="width:7%;"><span  style="width:8%; padding: 15px 10px;" class="text" >ID</span></td>
					<td style="width:10%;"><span style="width:11%; padding: 15px 10px;" class="text">Name</span></td>
					<td style="width:10%;"><span style="width:11%; padding: 15px 10px; " class="text">Country</span></td>
					<td style="width:23%;"><span style="width:23%; padding: 15px 10px;" class="text2">Email</span></td>
					...
					<td style="width:10%;"><span style="width:10%; padding: 15px 10px; text-align:center" class="text">Approve</span></td>
					<td style="width:10%;"><span style="width:10%; padding: 15px 10px; text-align:center" class="text">Delete</span></td>
				</tr>
			...
			<?php 	}else { ?>
				...
				<tr style="padding:15px 10px;">	
						<td style="width:7%; padding: 15px 10px; "><?php echo $tutor->uid; ?></td>
						...
						<td style="width:23%; padding: 15px 10px;"><?php echo $tutor->email; ?></td>
						<?php   $sql ="SELECT firstName FROM profile Where uid = '{$tutor->refid}'";
								$query = $this->db->query($sql);
								if ($query->num_rows() > 0) {

								foreach ($query->result() as $row) { ?>
								 <td style="width:15%; padding: 15px 10px; "><?php echo $row->firstName; ?> </td>
								 <?php
								}
							  }
						?> 
						
					<!--	<td style="width:15%; padding: 15px 10px; "><?php //echo $tutor->affiliate_name; ?></td> -->
						<td style="width:15%; padding: 15px 10px; text-align:center" ><?php echo $tutor->total_session; ?></td>
						<td style="width:10%; padding: 15px 10px; text-align:center"><input type="checkbox" class="checked_box" id="<?php echo $tutor->uid; ?>" onclick="approve()" value="1" <?php if($tutor->school_id_approve == '1'){ echo 'checked';}?>></td>
						<td style="width:10%; padding: 15px 10px; text-align:center"><a href="<?php echo base_url() . "user/delete_tutor/" . $tutor->uid; ?>">X</a></td>
			...
			<div class="slidingDiv_student" style="width:100%; float:left; padding-bottom: 50px;">
				...
				<tr style="width:100%; background-color:#D3D3D3; font-size:18px; color: #fff; height:52px; padding:15px 5px;">
					...
					<td style="width:10%;"><span style="width:12%; padding: 15px 10px;" class="text">Name</span></td>
					<td style="width:10%;"><span style="width:11%; padding: 15px 10px;" class="text">Country</span></td>
					<td style="width:20%;"><span style="width:21%; padding: 15px 10px;" class="text2">Email</span></td>
					<td style="width:20%;"><span style="width:20%; padding: 15px 10px;" class="text2">Affiliate Name</span></td>					
			...
			<?php 	}else { ?>
				<?php foreach($studets as $student){ ?>
				<tr style="padding:15px 10px;">					
						<td style="width:10%; padding: 15px 10px;"><?php echo $student->uid; ?></td>
						<td style="width:10%; padding: 15px 10px;"><?php echo $student->firstName; ?></td>
						<td style="width:10%; padding: 15px 10px;"><?php echo $student->country; ?></td>
						<td style="width:20%; padding: 15px 10px;"><?php echo $student->email; ?></td>
						<?php   $sql ="SELECT firstName FROM profile Where uid = '{$student->refid}'";
								$query = $this->db->query($sql);
								if ($query->num_rows() > 0) {
						...
						?>
						<!-- <td style="width:20%; padding: 15px 10px;"><?php echo $student->affiliate_name; ?></td> -->

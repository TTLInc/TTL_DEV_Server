        ...
        <?php
            ...
            <div class="banner_search_right">
				<?php if(!$login):?>
					...
					<a href="#" class="register_btn" id="register_btn" style="color:#000000;" ><?php echo $lngCreateAcct;?></a>
				<?php endif;?>
            </div>
        </div>
    </div>
...
<?php if($multi_lang == 'es'){ ?><div class="es-banner-main-mobile"><?php }else{ ?><div class="banner-main-mobile"><?php } ?>
    ...
    <?php if(!$login):?>
		<a href="<?php echo $fblogin_url; ?>"><img src="<?php echo base_url("images/fb-signin.png");?>" id="facebook" style='cursor:pointer;' /></a>
		<a href="#" class="register_btn" id="register_btn1" onclick="javascript:self.location='<?php echo base_url()."user/signup";?>'"><?php echo $lngCreateAcct;?></a>
	<?php endif;?>
    </div>
</div>
